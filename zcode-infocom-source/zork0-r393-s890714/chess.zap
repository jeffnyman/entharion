	...
	.FUNCT	PLAIN-F:ANY:0:1,RARG,PIECE
...
?PEN31:	ZERO?	PIECE /FALSE
	...
	.FUNCT	PLAIN-MOVEMENT-F:ANY:0:1,RARG
	ZERO?	RARG \FALSE
	EQUAL?	RANK,1 \?PRD6
...
?CND32:	PUTB	PIECE-MOVE-TABLE,DIR-CNT,PRSO
	IGRTR?	'DIR-CNT,1 \?CCL36
	EQUAL?	WINNER,WHITE-KNIGHT,BLACK-KNIGHT /?CCL36
	SUB	DIR-CNT,2
	GETB	PIECE-MOVE-TABLE,STACK
	EQUAL?	PRSO,STACK /?CCL36
	SET	'DIR-CNT,0
	COPYT	PIECE-MOVE-TABLE,0,8
	PRINT	CANNOT-TRAVEL
	ICALL1	STOP
	RTRUE	
?CCL36:	ZERO?	P-CONT /?CCL41
	SET	'CLOCK-WAIT,TRUE-VALUE
	RTRUE	
?CCL41:	SET	'DIR-CNT,0
	ICALL1	MOVE-PIECE
	RTRUE	
?CCL3:	EQUAL?	PRSA,V?ENTER \?CCL44
	EQUAL?	PRSO,WHITE-CASTLE \?CCL44
	CALL	NOUN-USED?,WHITE-CASTLE,W?MAN
	ZERO?	STACK \?CCL44
	PRINTR	"Oddly, there doesn't seem to be any entrance."
?CCL44:	EQUAL?	PRSA,V?ENTER \?CCL49
	EQUAL?	PRSO,BLACK-KNIGHT,WHITE-KNIGHT \?CCL49
	CALL	NOUN-USED?,PRSO,W?HORSE
	ZERO?	STACK /?CCL49
	PRINTR	"The horse isn't large enough for two riders."
?CCL49:	EQUAL?	PRSA,V?MOVE \?CCL54
	PRINTI	"Perhaps you should tell"
	ICALL1	TPRINT-PRSO
	PRINTR	" the direction(s)."
?CCL54:	EQUAL?	PRSA,V?GIVE \?CCL56
	FSET?	PRSO,TRYTAKEBIT /?CCL56
	CALL	FIND-IN,PRSO,TRYTAKEBIT
	ZERO?	STACK \?CCL56
	FSET?	PRSI,WHITEBIT /?CTR55
	FSET?	PRSI,BLACKBIT \?CCL56
?CTR55:	ZERO?	TIME-STOPPED /?CND63
	ICALL	PERFORM,V?TELL,PRSI
	RTRUE	
?CND63:	MOVE	PRSO,PRSI
	PRINTI	"The "
	ICALL2	DPRINT,PRSI
	PRINTI	" takes"
	ICALL1	TPRINT-PRSO
	PRINTC	46
	EQUAL?	PRSO,PIGEON \?CCL67
	CALL2	META-LOC,PERCH
	EQUAL?	HERE,STACK /?CCL67
	EQUAL?	HERE,OUBLIETTE \?CTR66
	EQUAL?	REMOVED-PERCH-LOC,OUBLIETTE /?CCL67
?CTR66:	CALL2	PIECE-TAKES-PIGEON,PRSI
	RSTACK	
?CCL67:	PRINTR	" ""Your graciousness is not unappreciated, your Lordship."""
?CCL56:	EQUAL?	PRSA,V?ASK-FOR \FALSE
	LOC	PRSI
	FSET?	STACK,WHITEBIT /?CCL74
	LOC	PRSI
	FSET?	STACK,BLACKBIT \FALSE
?CCL74:	ICALL	PERFORM,V?TAKE,PRSI
	RTRUE	


	.FUNCT	PIECE-TAKES-PIGEON:ANY:1:2,PIECE,DO-CR
	ASSIGNED?	'DO-CR /?CND1
...
?CND6:	PRINTI	" is gone."
	...
	.FUNCT	MOVE-PIECE:ANY:0:0,CNT,DIR,NEW-RANK,NEW-FILE,NEW-LOC,X,OFFSET,BLOCK,?TMP1
	SET	'NEW-RANK,RANK
	SET	'NEW-FILE,FILE
	SUB	NEW-RANK,1
	MUL	STACK,8 >?TMP1
	...
	SET	'CNT,0
?PRG1:	GETB	PIECE-MOVE-TABLE,CNT >DIR
...
?CCL19:	EQUAL?	DIR,P?NW \FALSE
	...
	.FUNCT	PIECE-SNARF:ANY:2:2,NEW-LOC,SNARFER,OBJ,CNT,TOOK-PIGEON
...
?REP2:	ZERO?	TOOK-PIGEON /FALSE
	...
	.FUNCT	TAKE-PIECE?:ANY:1:1,NEW-LOC,TAKEE,VAL
...
?CCL5:	ICALL	PIECE-AT-NEW-LOC?,NEW-LOC,TRUE-VALUE
	...
	.FUNCT	ILLEGAL-MOVE?:ANY:3:3,NEW-LOC,NEW-RANK,NEW-FILE,TAKEE,OLD-LOC
...
?CCL87:	PRINTR	"Bug7"
	...
	.FUNCT	PIECE-AT-NEW-LOC?:ANY:1:2,NEW-LOC,TAKE-PIECE,CNT,TAKEE
...
?CTR19:	RETURN	TAKEE
	...
	.FUNCT	OBSTRUCTION:ANY:2:3,L,DIR,CALLED-BY-EXIT-F,CHANGE
...
?CCL47:	ZERO?	CHANGE /TRUE
	...
	.FUNCT	CONSTRUCTION-ENTER-F:ANY:0:1,RARG
	ZERO?	RARG \FALSE
...
?CCL3:	EQUAL?	PRSA,V?MUNG \FALSE
	...
	.FUNCT	CONSTRUCTION-F:ANY:0:1,RARG,CNT
	EQUAL?	RARG,M-LOOK \?CCL3
...
?CCL3:	EQUAL?	RARG,M-ENTER \?CCL44
	...
	RSTACK	
?CCL44:	EQUAL?	RARG,M-BEG \FALSE
	EQUAL?	INTNUM,PRSO,PRSI \FALSE
	...
	.FUNCT	AND-OR-COMMA:ANY:1:1,CNT
	EQUAL?	CNT,1 \?CCL3
	PRINTI	" and "
	RTRUE	
?CCL3:	GRTR?	CNT,1 \FALSE
	...
	.FUNCT	CONSTRUCTION-MOVEMENT-F:ANY:0:1,RARG,CHANGE
	ZERO?	RARG \FALSE
...
?CCL7:	ADD	CONSTRUCTION-LOC,CHANGE >CONSTRUCTION-LOC
	...
	.FUNCT	REMOVE-ANY-PIECE:ANY:2:2,L,TAKER,TAKEE,CNT
...
?CND3:	ADD	CNT,2 >CNT
	...
	.FUNCT	PUT-IN-STORAGE:ANY:3:3,OFFSET,OBJ,L,CNT
...
?CCL5:	ADD	CNT,2 >CNT
	...
	.FUNCT	STORE:ANY:2:3,OFFSET,L,RM,CNT,F,N,OBJ,?TMP1
	ASSIGNED?	'RM /?CND1
	SET	'RM,HERE
?CND1:	FIRST?	RM >F /?BOGUS3
?BOGUS3:	CALL	ULTIMATELY-IN?,ROOSTER,RM
	ZERO?	STACK /?CND4
	LOC	ROOSTER
	FSET?	STACK,ACTORBIT /?CND4
	LOC	ROOSTER >?TMP1
	LOC	WORM
	EQUAL?	?TMP1,STACK \?CND4
	FSET?	WORM,ANIMATEDBIT \?CND4
	FSET?	ROOSTER,ANIMATEDBIT \?CND4
	SET	'ROOSTER-BURP,TRUE-VALUE
	REMOVE	WORM
?CND4:	CALL	ULTIMATELY-IN?,FOX,OBJ
	ZERO?	STACK /?PRG18
	LOC	FOX
	FSET?	STACK,ACTORBIT /?PRG18
	LOC	FOX >?TMP1
	LOC	ROOSTER
	EQUAL?	?TMP1,STACK \?PRG18
	FSET?	ROOSTER,ANIMATEDBIT \?PRG18
	FSET?	FOX,ANIMATEDBIT \?PRG18
	SET	'FOX-BURP,TRUE-VALUE
	REMOVE	ROOSTER
?PRG18:	ZERO?	F /TRUE
	NEXT?	F >N /?CND20
?CND20:	EQUAL?	F,PROTAGONIST /?CND24
?PRG26:	EQUAL?	F,JESTER \?CCL30
	ICALL1	REMOVE-J
	JUMP	?CND24
?CCL30:	GET	STORAGE-TABLE,CNT
	ZERO?	STACK \?CCL32
	ADD	L,OFFSET
	PUT	STORAGE-TABLE,CNT,STACK
	ADD	CNT,1
...
?CCL32:	ADD	CNT,2 >CNT
	...
	.FUNCT	UNSTORE:ANY:2:3,OFFSET,L,RM,CNT,LEN,NUM
	ASSIGNED?	'RM /?CND1
	SET	'RM,HERE
?CND1:	SET	'LEN,100
	ADD	L,OFFSET >NUM
?PRG3:	INTBL?	NUM,STORAGE-TABLE,LEN,132 >CNT \TRUE
	GET	CNT,1
	MOVE	STACK,RM
	PUT	CNT,1,0
	PUT	CNT,0,0
