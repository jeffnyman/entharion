	...
	.FUNCT	LAKE-SEGMENT-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \FALSE
	PICINF	LAKE-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	


	.FUNCT	WEST-SHORE-F:ANY:0:1,RARG
...
?CCL3:	EQUAL?	RARG,M-LOOK \FALSE
	...
	.FUNCT	NORTH-SHORE-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	LAKE-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	EQUAL?	RARG,M-LOOK \FALSE
	...
	IN?	YACHT,HERE \?CND7
	PRINT	YACHT-MOORED
?CND7:	PRINTI	". Tunnels lead north and northeast."
	RTRUE	


	.FUNCT	EAST-SHORE-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	LAKE-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	EQUAL?	RARG,M-LOOK \FALSE
...
?CND7:	PRINTC	46
	...
	.FUNCT	SOUTH-SHORE-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	LAKE-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	EQUAL?	RARG,M-LOOK \?CCL6
	...
	IN?	YACHT,HERE \?CND7
	PRINT	YACHT-MOORED
?CND7:	PRINTI	". The shore curves around toward the west."
	RTRUE	
...
?CCL31:	EQUAL?	PRSA,V?THROW-FROM \FALSE
	...
	.FUNCT	YACHT-PLAQUE-F:ANY:0:0
	EQUAL?	PRSA,V?READ,V?EXAMINE \FALSE
	PRINTR	"""Made by the Frobozz Magic Royal Yacht Company."""


	.FUNCT	YACHT-BUTTON-F:ANY:0:0
...
?CTR7:	PRINT	NOTHING-HAPPENS
	RTRUE	
?CCL8:	FSET?	SEAMANS-CAP,WORNBIT /?CCL12
	...
	ICALL1	J-EXITS
	RTRUE	
?CCL12:	CALL	ADJ-USED?,PSEUDO-OBJECT,W?WHITE,W?FIFTH
	ZERO?	STACK \?CTR13
	CALL	ADJ-USED?,PSEUDO-OBJECT,W?MIDDLE,W?CENTER
	ZERO?	STACK /?CCL14
?CTR13:	EQUAL?	HERE,LAKE-FLATHEAD \?CCL19
	ICALL2	DEQUEUE,I-YACHT
	PRINT	NOTHING-HAPPENS
	RTRUE	
?CCL19:	SET	'YACHT-DESTINATION,LAKE-FLATHEAD
	ICALL2	I-YACHT,TRUE-VALUE
	RTRUE	
?CCL14:	IN?	DB,HOLD /?CCL21
	PRINTR	"A message flashes: ""Warning -- diving bell lowered!"""
?CCL21:	CALL	ADJ-USED?,PSEUDO-OBJECT,W?RED
	ZERO?	STACK /?CCL23
	EQUAL?	HERE,NORTH-SHORE \?CCL26
	PRINT	NOTHING-HAPPENS
	RTRUE	
?CCL26:	SET	'YACHT-DESTINATION,NORTH-SHORE
	ICALL2	I-YACHT,TRUE-VALUE
	RTRUE	
?CCL23:	CALL	ADJ-USED?,PSEUDO-OBJECT,W?GREEN
	ZERO?	STACK /?CCL28
	EQUAL?	HERE,SOUTH-SHORE \?CCL31
	PRINT	NOTHING-HAPPENS
	RTRUE	
?CCL31:	SET	'YACHT-DESTINATION,SOUTH-SHORE
	ICALL2	I-YACHT,TRUE-VALUE
	RTRUE	
?CCL28:	CALL	ADJ-USED?,PSEUDO-OBJECT,W?BLUE
	ZERO?	STACK /?CCL33
	EQUAL?	HERE,EAST-SHORE \?CCL36
	PRINT	NOTHING-HAPPENS
	RTRUE	
?CCL36:	SET	'YACHT-DESTINATION,EAST-SHORE
	ICALL2	I-YACHT,TRUE-VALUE
	RTRUE	
?CCL33:	EQUAL?	HERE,WEST-SHORE \?CCL39
	PRINT	NOTHING-HAPPENS
	RTRUE	
?CCL39:	SET	'YACHT-DESTINATION,WEST-SHORE
	ICALL2	I-YACHT,TRUE-VALUE
	RTRUE	


	.FUNCT	YACHT-CONTROLS-F:ANY:0:0
	...
	.FUNCT	I-YACHT:ANY:0:1,CALLED-BY-BUTTON-F
...
?CND8:	IN?	YACHT,YACHT-DESTINATION \TRUE
	...
	.FUNCT	YACHT-ENTER-F:ANY:0:1,RARG
	ZERO?	RARG \FALSE
	RETURN	YACHT


	.FUNCT	DB-ENTER-F:ANY:0:1,RARG
	ZERO?	RARG \FALSE
...
?CCL5:	ICALL1	RETURN-FROM-MAP
	...
	ICALL2	DO-FIRST,STR?574
	RFALSE	


	.FUNCT	DB-F:ANY:0:1,VARG
	ZERO?	VARG /?CCL3
	EQUAL?	VARG,M-ENTER \FALSE
?CCL3:	ZERO?	VARG /?CCL7
...
?CCL17:	EQUAL?	PRSA,V?EXIT \?CCL22
	...
	CALL2	DO-FIRST,STR?575
	RSTACK	
?CCL27:	FSET?	DB,OPENBIT /?CCL29
	ICALL2	THIS-IS-IT,DB
	CALL2	DO-FIRST,STR?574
	RSTACK	
...
?CCL33:	EQUAL?	PRSA,V?OPEN \FALSE
	...
	CALL2	JIGS-UP,STR?576
	RSTACK	


	.FUNCT	DB-CONTROLS-F:ANY:0:0
	EQUAL?	PRSA,V?EXAMINE \FALSE
	...
	.FUNCT	G-DB-HOLE-F:ANY:2:2,TBL,F
	GET	F,6
...
?CCL3:	RETURN	HAND-HOLE
	...
	.FUNCT	PORTHOLE-F:ANY:0:0
	EQUAL?	PRSA,V?LOOK-INSIDE \FALSE
	CALL1	V-LOOK
	RSTACK	


	.FUNCT	WALDO-F:ANY:0:0
...
?CCL36:	PRINTR	"Your hand isn't in the hand-hole!"
	...
	.FUNCT	HAND-HOLE-F:ANY:0:0
	CALL2	TOUCHING?,HAND-HOLE
	ZERO?	STACK /?CCL3
	IN?	PROTAGONIST,DB /?CCL3
	CALL2	CANT-REACH,HAND-HOLE
	RSTACK	
?CCL3:	EQUAL?	PRSA,V?REACH-IN \?CCL7
	PRINTI	"Your hand is "
	ZERO?	HAND-IN-WALDO /?CCL10
	PRINTR	"already in the hand-hole!"
?CCL10:	SET	'HAND-IN-WALDO,TRUE-VALUE
	PRINTI	"now in the hand-hole"
	FSET?	WALDO,TOUCHBIT /?CND11
	FSET	WALDO,TOUCHBIT
	PRINTI	". The waldo feels like an extension of your own hand. You flex your fingers a few times"
	FSET?	EXTERIOR-LIGHT,ONBIT /?CCL14
	EQUAL?	HERE,HOLD \?CND11
?CCL14:	PRINTI	", and through the viewport, you see the waldo flex correspondingly"
?CND11:	PRINT	PERIOD-CR
	RTRUE	
?CCL7:	EQUAL?	PRSA,V?LOOK-INSIDE \FALSE
	ZERO?	HAND-IN-WALDO /?CCL21
	PRINTR	"Your hand is in the hole."
?CCL21:	PRINT	ONLY-BLACKNESS
	RTRUE	


	.FUNCT	WALDO-TAKE:ANY:0:0
...
?CCL21:	CALL1	YUKS
	...
	.FUNCT	LEVER-F:ANY:0:0,X
	CALL2	TOUCHING?,LEVER
	ZERO?	STACK /?CCL3
	IN?	PROTAGONIST,DB /?CCL3
	CALL2	CANT-REACH,LEVER
	RSTACK	
?CCL3:	EQUAL?	PRSA,V?EXAMINE \?CCL7
	PRINTI	"The lever is in the "
	EQUAL?	DB-DIRECTION,1 \?CCL10
	PRINTI	"up"
	JUMP	?CND8
?CCL10:	EQUAL?	DB-DIRECTION,-1 \?CCL12
	PRINTI	"down"
	JUMP	?CND8
?CCL12:	PRINTI	"neutral"
?CND8:	PRINTI	" position"
	ZERO?	DB-DIRECTION \?CCL15
	PRINTR	", from which it can be raised or lowered."
?CCL15:	PRINT	PERIOD-CR
	RTRUE	
?CCL7:	EQUAL?	PRSA,V?RAISE \?CCL17
	EQUAL?	DB-DIRECTION,1 \?CCL20
	PRINTR	"The lever is already raised."
?CCL20:	EQUAL?	HERE,HOLD \?CCL22
	PRINT	NOTHING-HAPPENS
	RTRUE	
?CCL22:	SET	'DB-DIRECTION,1
	ICALL	QUEUE,I-DB,2
	PRINTI	"The bathysphere ascends."
	EQUAL?	HERE,LAKE-BOTTOM \?CCL25
	SET	'DB-DEPTH,4
	MOVE	DB,UNDERWATER
...
?CCL25:	CRLF	
	RTRUE	
?CCL17:	EQUAL?	PRSA,V?LOWER \FALSE
	EQUAL?	DB-DIRECTION,-1 \?CCL30
	PRINTR	"The lever is already lowered."
?CCL30:	EQUAL?	DB-DEPTH,4 /?CTR31
	IN?	YACHT,LAKE-FLATHEAD /?CCL32
?CTR31:	PRINT	NOTHING-HAPPENS
	RTRUE	
?CCL32:	FIRST?	WALDO >X \?CCL36
	EQUAL?	X,FOX,FLAMINGO,ROOSTER /?CTR35
	EQUAL?	X,SNAKE \?CCL36
?CTR35:	PRINTI	"You'd drown the poor "
	PRINTD	X
	PRINTR	"!"
?CCL36:	FSET?	DB,OPENBIT \?CCL42
	CALL2	JIGS-UP,STR?581
	RSTACK	
?CCL42:	SET	'DB-DIRECTION,-1
	ICALL	QUEUE,I-DB,2
...
?CCL26:	ADD	PIECE-DROWNED,10 >PIECE-DROWNED
	...
	.FUNCT	LAKE-FLATHEAD-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	LAKE-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	ZERO?	RARG \FALSE
	EQUAL?	PRSA,V?ENTER,V?DRINK-FROM,V?DRINK /?CTR7
	EQUAL?	PRSA,V?REACH-IN,V?LOOK-UNDER \?CCL8
?CTR7:	CALL	PERFORM-PRSA,WATER,PRSI
	RSTACK	
?CCL8:	EQUAL?	PRSA,V?PUT,V?FILL \?CCL12
	EQUAL?	PRSI,GLOBAL-HERE \?CCL12
...
?CCL12:	EQUAL?	PRSA,V?LOOK-INSIDE,V?EXAMINE \FALSE
	...
	.FUNCT	LAKE-BOTTOM-FISH-F:ANY:0:0
	...
	.FUNCT	LAKE-BOTTOM-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	LAKE-SEGMENT-PIC,PICINF-TBL /?BOGUS4
?BOGUS4:	MOVE	SPENSEWEED,HERE
...
?CCL3:	EQUAL?	RARG,M-END \FALSE
	...
	.FUNCT	G-U-MOUNTAIN-ENTER-F:ANY:0:1,RARG
...
?CCL3:	RETURN	G-U-MOUNTAIN
	...
	.FUNCT	STABLE-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \FALSE
	PICINF	LAKE-SEGMENT-PIC,PICINF-TBL /?BOGUS4
?BOGUS4:	FSET?	STABLE,TOUCHBIT /FALSE
	ICALL	QUEUE,I-ROOSTER,-1
	RFALSE	


	.FUNCT	STALL-PS:ANY:0:0
...
?CCL13:	CALL2	VISIBLE?,WORM
	ZERO?	STACK /FALSE
	FSET?	WORM,ANIMATEDBIT \FALSE
	CALL2	PROB,ROOSTER-PROB
	ZERO?	STACK /?CCL19
	EQUAL?	CURRENT-SPLIT,MAP-TOP-LEFT-LOC /?CCL19
	SET	'ROOSTER-PROB,0
...
?CCL19:	ADD	ROOSTER-PROB,10 >ROOSTER-PROB
	...
	.FUNCT	G-U-MOUNTAIN-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	LAKE-SEGMENT-PIC,PICINF-TBL /?BOGUS4
?BOGUS4:	GRTR?	ORACLE-EXIT-NUMBER,4 \FALSE
	RANDOM	5
...
?CCL3:	EQUAL?	RARG,M-LOOK \FALSE
	...
	IN?	BOULDER,HERE \?CCL11
	PRINTI	"An enormous boulder is balanced precariously at the western edge of the plateau"
	JUMP	?CND9
?CCL11:	PRINTI	"A small cave opens to the north"
?CND9:	PRINTI	". A trail leads down the mountain to the west."
	RTRUE	


	.FUNCT	CAVE-ENTER-F:ANY:0:1,RARG
...
?CCL17:	EQUAL?	PRSA,V?PUSH-DIR \FALSE
	...
	.FUNCT	CAVE-OBJECT-F:ANY:0:0
	EQUAL?	PRSA,V?ENTER \FALSE
	CALL2	GOTO,GROTTO
	RSTACK	


	.FUNCT	LOWEST-HALL-ENTER-F:ANY:0:1,RARG,CURRENT-GRAVEL,SPILL
	ZERO?	RARG /?CND1
	RETURN	LOWEST-HALL
?CND1:	ICALL1	RETURN-FROM-MAP
	PRINT	STR?597
	PRINTI	"gravel, drop your possessions, and begin sliding down the dark tunnel! Finally, you land on a hard floor"
...
?CND28:	SET	'HERE,LOWEST-HALL
	...
	.FUNCT	G-GRAVEL-F:ANY:2:2,TBL,LEN,?TMP1
	ADD	TBL,8 >?TMP1
	GET	TBL,1
...
?PRD49:	EQUAL?	PRSO,BOWL \FALSE
	...
	.FUNCT	GRAVEL-COUNT:ANY:0:0,CNT
	SET	'CNT,0
	IN?	GRAVEL,BOWL \?CND1
	INC	'CNT
...
?CCL26:	PRINTI	"The bowl's narrowness prevents you from filling"
	...
	.FUNCT	LAIR-EXIT-F:ANY:0:1,RARG
	ZERO?	RARG \?CCL2
	EQUAL?	CURRENT-SPLIT,MAP-TOP-LEFT-LOC \?CND1
?CCL2:	RETURN	G-U-WOODS
?CND1:	PRINT	STR?597
	PRINTI	"treacherous path, and tumble painfully down a steep incline. "
...
?CND5:	PRINTI	"You roll to a stop as dim green light filters around you"
	...
	.FUNCT	G-U-WOODS-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \FALSE
	PICINF	LAKE-SEGMENT-PIC,PICINF-TBL /?BOGUS4
?BOGUS4:	FSET?	G-U-WOODS,TOUCHBIT /FALSE
	ICALL	QUEUE,I-FOX,-1
	RFALSE	
...
?CCL16:	EQUAL?	PRSA,V?FEED \FALSE
	...
	.FUNCT	WOULDNT-MIND:ANY:2:2,EATER,EATEE
	PRINTI	"The "
	ICALL2	DPRINT,EATER
...
?CCL3:	EQUAL?	PRSA,V?STAND-ON,V?ENTER,V?CROSS \FALSE
	...
	.FUNCT	BRIDGE-ENTER-F:ANY:0:1,RARG
	ZERO?	RARG \FALSE
	IN?	BRIDGE,HERE \?CCL5
...
?CCL3:	EQUAL?	PRSA,V?LISTEN \FALSE
	...
	.FUNCT	STREAM-OBJECT-F:ANY:0:0
	EQUAL?	PRSA,V?CROSS \FALSE
	CALL2	DO-WALK,P?WEST
	RSTACK	


	.FUNCT	CAMEL-DRINK-ROOM-F:ANY:0:1,RARG
...
?CCL3:	EQUAL?	RARG,M-ENTER \?CCL10
	PICINF	LAKE-SEGMENT-PIC,PICINF-TBL /?BOGUS11
?BOGUS11:	EQUAL?	HERE,STREAM \FALSE
...
?CCL10:	EQUAL?	RARG,M-END \FALSE
	EQUAL?	HERE,STREAM \?CND18
	IN?	JESTER,HERE \?CND18
	FSET?	DIPLOMA,TRYTAKEBIT \?CND18
	ICALL2	SETUP-ORPHAN,STR?38
?CND18:	IN?	CAMEL,HERE \FALSE
	FSET?	CAMEL,ANIMATEDBIT \FALSE
	ZERO?	CAMEL-THIRSTY /FALSE
	SET	'CAMEL-THIRSTY,FALSE-VALUE
	ICALL1	RETURN-FROM-MAP
	PRINTI	"   The camel lumbers over to the "
	EQUAL?	HERE,OASIS \?CCL31
	PRINTI	"oasis"
	JUMP	?CND29
?CCL31:	PRINTI	"stream"
?CND29:	PRINTR	" and takes an amazingly long sip."

	.SEGMENT "0"


	.FUNCT	DIPLOMA-F:ANY:0:0
	EQUAL?	PRSA,V?TAKE \FALSE
	FSET?	DIPLOMA,TRYTAKEBIT \FALSE
	IN?	DIPLOMA,JESTER \?CCL8
	PRINT	ANSWER-MY-RIDDLE
	RTRUE	
?CCL8:	CALL2	DO-FIRST,STR?614
	RSTACK	
	...
	.FUNCT	G-CAMEL-F:ANY:2:2,X,Y
	RETURN	CAMEL


	.FUNCT	CAMEL-F:ANY:0:1,VARG
	FSET?	CAMEL,ANIMATEDBIT \FALSE
...
?CND1:	FSET	CAMEL,ANIMATEDBIT
	...
	.FUNCT	DESERT-ENTER-F:ANY:0:1,RARG
	ZERO?	RARG /?CCL3
	RETURN	G-U-DESERT
...
?CCL5:	CALL2	TOUCHING?,CACTI
	...
	.FUNCT	DESERT-ROOM-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	LAKE-SEGMENT-PIC,PICINF-TBL /?BOGUS4
?BOGUS4:	IN?	PROTAGONIST,CAMEL /FALSE
	INC	'DESERT-DEATH
	ICALL	QUEUE,I-DESERT-RESET,-1
	ICALL1	RETURN-FROM-MAP
	PRINTI	"You trudge along beneath the searing gaze of an artificial desert sun"
	EQUAL?	DESERT-DEATH,4 \?CCL9
	PRINTI	". Wavering dizziness threatens your every step"
	JUMP	?CND7
?CCL9:	EQUAL?	DESERT-DEATH,3 \?CND7
	PRINTI	". You won't last much longer in this heat"
?CND7:	PRINT	ELLIPSIS
	RFALSE	
?CCL3:	EQUAL?	RARG,M-END \FALSE
	...
	.FUNCT	PHIL-HALL-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	LAKE-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	EQUAL?	RARG,M-LOOK \FALSE
	...
	IN?	CONDUCTOR-STAND,HERE \?CND7
	PRINTI	"A lone spotlight illuminates the conductor's stand. "
?CND7:	PRINTI	"Passages lead east, north and south."
	RTRUE	


	.FUNCT	PHIL-SHADOW-PS:ANY:0:0
	EQUAL?	PRSA,V?EXAMINE \FALSE
	PRINTR	"Like most shadows, a little creepy."


	.FUNCT	SPOTLIGHT-PS:ANY:0:0
	EQUAL?	PRSA,V?EXAMINE \?CCL3
...
?CCL12:	PRINTR	"You stand in the center of the circle of light, to little effect."
	...
	.FUNCT	CONDUCTOR-STAND-F:ANY:0:1,OARG
	ZERO?	OARG \FALSE
...
?CCL18:	CRLF	
	...
	.FUNCT	CONDUCTOR-PIT-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \FALSE
	PICINF	LAKE-SEGMENT-PIC,PICINF-TBL /?BOGUS4
?BOGUS4:	IN?	CONDUCTOR-STAND,CONDUCTOR-PIT /FALSE
