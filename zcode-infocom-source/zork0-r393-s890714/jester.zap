...
?CND23:	PRINTI	". Nothing. "
	...
	.FUNCT	I-JESTER:ANY:0:1,CALLED-BY-DOORBELL,PLUR,APPEAR-PROB
...
?CCL37:	FSET	JESTER,TOUCHBIT
	PRINT	STR?962
	PRINTI	"notice a wiry fellow with an outrageous costume and a feral grin. ""I'm the jester of the castle, I may pester, I may hassle; and I often speak in rhyme, for it helps to pass the time!"""
...
?CND44:	CRLF	
	...
	ICALL1	J-EXITS
	JUMP	?CND53
?CCL58:	ICALL2	SETUP-ORPHAN,STR?38
...
?CCL60:	EQUAL?	HERE,OUBLIETTE \?CCL62
	...
	ICALL2	GOTO,DUNGEON
	JUMP	?CND53
?CCL65:	ICALL2	SETUP-ORPHAN,STR?38
...
?CND53:	ADD	SLATE-PROB,2 >SLATE-PROB
	...
	.FUNCT	J-EXITS:ANY:0:1,JUST-DID-SLATE-OR-SCROLL,DO-FUNNY-PAPER,LIT?
	ICALL1	REMOVE-J
	CALL2	PROB,FUNNY-PAPER-PROB
	ZERO?	STACK /?CND1
...
?CCL18:	CALL2	PROB,15
	...
	EQUAL?	HERE,HOLD,GONDOLA,BATS-LAIR /?CCL20
	EQUAL?	HERE,ROOF,PARAPET,CONDUCTOR-PIT /?CCL20
	EQUAL?	HERE,OUTER-BAILEY /?CCL20
	GETP	HERE,P?REGION
	EQUAL?	STACK,STR?241 /?CCL20
	...
	PRINT	ELLIPSIS
	EQUAL?	HERE,CONSTRUCTION \?CCL31
	ICALL	STORE,CONSTRUCTION-OFFSET,CONSTRUCTION-LOC,CONSTRUCTION
	JUMP	?CND29
?CCL31:	EQUAL?	HERE,FR-OFFICES \?CCL33
	ICALL	STORE,OFFICES-OFFSET,FLOOR-NUMBER,FR-OFFICES
	JUMP	?CND29
?CCL33:	EQUAL?	HERE,OFFICES-NORTH \?CCL35
	ICALL	STORE,OFFICES-N-OFFSET,FLOOR-NUMBER,OFFICES-NORTH
	JUMP	?CND29
?CCL35:	EQUAL?	HERE,OFFICES-SOUTH \?CCL37
	ICALL	STORE,OFFICES-S-OFFSET,FLOOR-NUMBER,OFFICES-SOUTH
	JUMP	?CND29
?CCL37:	EQUAL?	HERE,OFFICES-EAST \?CCL39
	ICALL	STORE,OFFICES-E-OFFSET,FLOOR-NUMBER,OFFICES-EAST
	JUMP	?CND29
?CCL39:	EQUAL?	HERE,OFFICES-WEST \?CND29
	ICALL	STORE,OFFICES-W-OFFSET,FLOOR-NUMBER,OFFICES-WEST
?CND29:	MOVE	PROTAGONIST,HERE
	CALL	FIND-IN,PROTAGONIST,ONBIT >LIT?
	ZERO?	LIT? \?CND41
	CALL	FIND-IN,HERE,ONBIT >LIT?
	ZERO?	LIT? /?CND41
	MOVE	LIT?,PROTAGONIST
?CND41:	CALL1	BEYOND-LAKE?
	ZERO?	STACK \?CTR46
	ZERO?	LIT? /?CCL47
	CALL2	PROB,25
	ZERO?	STACK /?CCL47
?CTR46:	PUSH	BATS-LAIR
	JUMP	?CND45
?CCL47:	ZERO?	SECRET-PASSAGE-OPEN /?CCL53
	ZERO?	LIT? /?CCL53
	CALL2	PROB,40
	ZERO?	STACK /?CCL53
	PUSH	PARAPET
	JUMP	?CND45
?CCL53:	FSET?	DRAWBRIDGE,OPENBIT \?CCL58
	CALL2	PROB,50
	ZERO?	STACK /?CCL58
	PUSH	OUTER-BAILEY
	JUMP	?CND45
?CCL58:	PUSH	ROOF
?CND45:	ICALL2	GOTO,STACK
	SET	'P-CONT,-1
	RTRUE	
?CCL20:	CALL2	PROB,33
	ZERO?	STACK /?CCL62
	EQUAL?	HERE,UNDER-THE-WORLD,HANGING-FROM-ROOTS,SHOULDER /?CCL62
	EQUAL?	HERE,EAR,INNER-EAR /?CCL62
	ZERO?	HUNGER-COUNT \?CCL62
	EQUAL?	JUMP-X,99 \?CCL62
	EQUAL?	JUMP-Y,99 \?CCL62
	SET	'ALLIGATOR,TRUE-VALUE
	ICALL	QUEUE,I-UNALLIGATOR,4
	PRINTI	"See you later, alligator!"" Your skin feels itchy"
	FIRST?	PROTAGONIST \?CND70
	PRINTI	" and you've dropped what you were holding"
?CND70:	PRINTC	46
	LOC	PROTAGONIST
	FSET?	STACK,DROPBIT \?CCL74
	LOC	PROTAGONIST
	JUMP	?CND72
?CCL74:	PUSH	HERE
?CND72:	ICALL	ROB,PROTAGONIST,STACK
	SET	'P-CONT,-1
	CRLF	
	JUMP	?CND16
?CCL62:	CALL2	PROB,50
	ZERO?	STACK \?CTR75
	ZERO?	ALLIGATOR \?CTR75
	FSET?	CLOWN-NOSE,WORNBIT \?CCL76
?CTR75:	PRINTI	"So long, and thanks for all the fish!"" Odd. You've never given the jester any fish."
	CRLF	
	JUMP	?CND16
?CCL76:	MOVE	CLOWN-NOSE,PROTAGONIST
	FSET	CLOWN-NOSE,WORNBIT
	ICALL	QUEUE,I-SUFFOCATE,-1
	SET	'P-CONT,-1
	PRINTI	"Catch you aroun', clown!"" "
	PRINT	STR?962
	PRINTI	"find yourself having a bit of difficulty breathing."
	CRLF	
?CND16:	ADD	FUNNY-PAPER-PROB,5 >FUNNY-PAPER-PROB
	RETURN	FUNNY-PAPER-PROB


	.FUNCT	BEYOND-LAKE?:ANY:0:0
...
?CCL9:	EQUAL?	SUFFOCATE-COUNTER,11 \FALSE
	ICALL1	RETURN-FROM-MAP
	CALL2	JIGS-UP,STR?964
	RSTACK	


	.FUNCT	I-FUNNY-PAPER:ANY:0:0
	LOC	PROTAGONIST
	...
	.FUNCT	I-REMOVE-FUNNY-PAPER:ANY:0:0,TOLD
...
?CND23:	PRINTR	"."""
	...
	.FUNCT	WEST-SEGMENT-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \FALSE
	PICINF	WEST-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	


	.FUNCT	SHELL-F:ANY:0:0
...
?CCL5:	EQUAL?	PRSA,V?EXAMINE,V?LOOK-INSIDE \FALSE
	...
	.FUNCT	ANOTHER-SHELL-GAME:ANY:0:0
	...
	.FUNCT	SEE-BILL?:ANY:0:0,BILL-LOC
	FSET?	GOGGLES,WORNBIT \FALSE
	CALL2	PROB,33
	ZERO?	STACK /?CCL6
...
?CND9:	ICALL2	TPRINT,BILL-LOC
	...
	.FUNCT	JESTERS-QUARTERS-F:ANY:0:1,RARG
...
?CCL3:	EQUAL?	RARG,M-LOOK \FALSE
	...
	FSET?	LARGE-DOOR,OPENBIT \?CCL9
	PRINTI	"The large door is open but the small door is"
	JUMP	?CND7
?CCL9:	PRINTI	"Both doors are"
?CND7:	PRINTI	" closed."
	RTRUE	


	.FUNCT	SMALL-DOOR-ENTER-F:ANY:0:1,RARG
	ZERO?	RARG \FALSE
	ICALL1	RETURN-FROM-MAP
	ICALL	DO-FIRST,STR?142,SMALL-DOOR
	ICALL2	THIS-IS-IT,SMALL-DOOR
	RFALSE	


	.FUNCT	LARGE-DOOR-F:ANY:0:0
	EQUAL?	PRSA,V?OPEN \FALSE
	ZERO?	TOWER-BEATEN \FALSE
	PRINTR	"Although there's no visible lock, the door refuses to budge."


	.FUNCT	G-J-DOOR-F:ANY:2:2,TBL,LEN
...
?CCL3:	EQUAL?	PRSA,V?CLOSE \FALSE
	...
	.FUNCT	SMALL-DOOR-F:ANY:0:0,WEIGHT-CNT,FUDGE,?TMP1,?TMP2
...
?CND6:	PRINT	PERIOD-CR
	...
	PRINTI	"Or, if you'd rather use your mouse"
	CALL1	APPLE?
	ZERO?	STACK \?CCL11
	GETB	0,30
	EQUAL?	STACK,IBM \?CND10
?CCL11:	PRINTI	"/joystick"
?CND10:	PRINTI	", click on the weight you want to move, then click on the peg you want to move it to. "
?CND8:	PRINTI	"You can Undo your move by typing U"
	ZERO?	ACTIVE-MOUSE /?CND14
...
?CCL18:	PRINTC	46
?CND16:	PRINTI	" Type X"
	ZERO?	ACTIVE-MOUSE /?CND19
	PRINTI	" (or click on the EXIT spot)"
?CND19:	PRINTI	" to exit."
	...
	RTRUE	
?CCL3:	EQUAL?	PRSA,V?EXAMINE \?CCL22
	PRINTR	"The small door is closed."
?CCL22:	EQUAL?	PRSA,V?CLOSE \FALSE
	PRINTR	"It is!"


	.FUNCT	WEIGHT-F:ANY:0:0,CNT,RECURSING
...
?CND16:	PRINTC	46
	...
	.FUNCT	TOWER-MODE:ANY:0:0,CHAR,WGT,PEG,X,JUST-UNDID,?TMP1
...
?CCL47:	ZERO?	ACTIVE-MOUSE /?CCL50
	...
	ZERO?	STACK \?CCL52
	GETB	0,30
	EQUAL?	STACK,IBM \?CND51
?CCL52:	PRINTI	"/joystick"
?CND51:	PRINTI	" or t"
	JUMP	?CND48
?CCL50:	PRINTC	84
?CND48:	PRINTI	"ype L (left) or C (center) or R (right) to specify the peg you'd like to move the "
	...
	PRINTI	" to."
	ICALL1	2CR-TO-PRINTER
	ZERO?	DEMO-VERSION? /?CCL57
	CALL2	INPUT-DEMO,1 >CHAR
	JUMP	?CND55
?CCL57:	INPUT	1 >CHAR
?CND55:	ICALL1	MOUSE-INPUT?
	EQUAL?	CHAR,CLICK1,CLICK2 \?CND58
	CALL1	B-MOUSE-PEG-PICK >CHAR
?CND58:	CLEAR	S-TEXT
	EQUAL?	CHAR,76,108,82 /?CCL62
	EQUAL?	CHAR,114,67,99 /?CCL62
	PRINTI	"Next time, "
	EQUAL?	CHAR,CLICK1 \?CCL67
	PRINTI	"click on the left, center, or right peg!"
	JUMP	?CND65
?CCL67:	PRINTI	"type R (right), L (left), or C (center) to specify a destination peg!"
?CND65:	ICALL1	2CR-TO-PRINTER
	JUMP	?PRG1
?CCL62:	EQUAL?	CHAR,76,108 \?CCL70
	SET	'PEG,LEFT-PEG
	JUMP	?CND68
?CCL70:	EQUAL?	CHAR,82,114 \?CCL72
	SET	'PEG,RIGHT-PEG
	JUMP	?CND68
?CCL72:	SET	'PEG,CENTER-PEG
?CND68:	ICALL1	B-SAVE
	ZERO?	TOWER-CHANGED /?PRD76
	ZERO?	JUST-UNDID /?CND73
?PRD76:	ZERO?	ACTIVE-MOUSE /?CND73
	...
	SCREEN	S-TEXT
?CND73:	SET	'JUST-UNDID,FALSE-VALUE
	CALL	PERFORM,V?MOVE-TO,WGT,PEG >X
	JUMP	?PRG1
?CCL29:	EQUAL?	CHAR,76,108,82 /?CTR79
	EQUAL?	CHAR,114,67,99 \?CCL80
?CTR79:	PRINTI	"You must select a weight before you select a destination!"
	ICALL1	2CR-TO-PRINTER
	JUMP	?PRG1
?CCL80:	PRINT	TYPE-A-NUMBER
	PRINTI	"6, U for Undo, or X to eXit the Tower of Bozbar game."
	ICALL1	2CR-TO-PRINTER
	JUMP	?PRG1


	.FUNCT	B-MOUSE-PEG-PICK:ANY:0:0,TL-X,TL-Y,BR-X,BR-Y,WEIGHT-WIDTH,WEIGHT-HEIGHT
...
?CCL8:	SOUND	1
	...
	.FUNCT	B-MOUSE-WEIGHT-PICK:ANY:0:0,TL-X,TL-Y,BR-X,BR-Y,NUM,TBL,CNT-X,CNT-Y,WEIGHT-WIDTH,WEIGHT-HEIGHT
	ICALL2	PICINF-PLUS-ONE,TOWER-UNDO-BOX-LOC
	GET	PICINF-TBL,1 >TL-X
	GET	PICINF-TBL,0 >TL-Y
...
?CCL11:	IN?	1-WEIGHT,CENTER-PEG \FALSE
	...
	.FUNCT	SET-PEG-TABLE:ANY:1:1,PEG
...
?CTR4:	RETURN	CENTER-PEG-TABLE
	...
	.FUNCT	NOT-TOP-WEIGHT:ANY:1:1,WGT,TBL,CNT,NOT-TOP
	LOC	WGT
...
?CND3:	INC	'CNT
	...
	.FUNCT	MOVE-WEIGHT:ANY:2:2,WGT,PEG,TBL,CNT,X,?TMP1
	SCREEN	S-WINDOW
	LOC	WGT
...
?CND17:	INC	'CNT
	...
	.FUNCT	CRUSH-WEIGHT:ANY:3:3,WGT,PEG,RECURSING,TBL,CNT,CRUSHED,X,?TMP1
	CALL2	SET-PEG-TABLE,PEG >TBL
?PRG1:	GET	TBL,CNT
	EQUAL?	STACK,WGT \?CND3
	ZERO?	CNT \?CCL7
...
?CND9:	GET	TOWER-UNDO-TABLE,23
	...
	.FUNCT	DRAW-TOWER:ANY:0:1,UNDOING,CNT,WGT,PEG-LOC,?TMP1,?TMP2
	CLEAR	S-FULL
	SCREEN	S-FULL
...
?CND1:	SCREEN	S-TEXT
	...
	.FUNCT	DRAW-PEG:ANY:2:2,TBL,X,WGT,CNT,?TMP1
	GET	B-X-TBL,X >X
...
?CCL11:	EQUAL?	WGT,6-WEIGHT \FALSE
	...
	.FUNCT	WEIRD-EXIT-F:ANY:0:1,RARG
...
?CCL3:	ZERO?	RARG \FALSE
	...
	.FUNCT	WEIRD-ENTER-F:ANY:0:1,RARG
...
?CCL3:	ZERO?	RARG \FALSE
	...
	.FUNCT	WEIRD-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	EAST-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	EQUAL?	RARG,M-BEG \?CCL6
	EQUAL?	LEFT-RIGHT,PRSO,PRSI \?CCL6
	CALL	NOUN-USED?,LEFT-RIGHT,W?LEFT
	ZERO?	STACK /?CCL11
	EQUAL?	TOWER-BEATEN,PYRAMID-L \?CCL11
	CALL2	DO-WALK,P?WEST
	RSTACK	
?CCL11:	CALL	NOUN-USED?,LEFT-RIGHT,W?RIGHT
	ZERO?	STACK /FALSE
	EQUAL?	TOWER-BEATEN,PYRAMID-R \FALSE
...
?CCL6:	EQUAL?	RARG,M-LOOK \FALSE
	...
	ZERO?	TOWER-BEATEN \?CCL22
	PRINTI	"ends abruptly to the north"
	JUMP	?CND20
?CCL22:	EQUAL?	TOWER-BEATEN,PYRAMID \?CCL24
	PRINTI	"continues straight ahead, to the north"
	JUMP	?CND20
?CCL24:	PRINTI	"curves sharply to the "
	EQUAL?	TOWER-BEATEN,PYRAMID-L \?CCL27
	PRINTI	"left"
	JUMP	?CND25
?CCL27:	PRINTI	"right"
?CND25:	PRINTI	" here, ending at an archway to the "
	EQUAL?	TOWER-BEATEN,PYRAMID-L \?CCL30
	PRINTI	"west"
	JUMP	?CND20
?CCL30:	PRINTI	"east"
?CND20:	PRINTI	". To the south, the passage ends at a large arched door which is "
...
?CCL3:	EQUAL?	RARG,M-LOOK \FALSE
	...
	EQUAL?	TOWER-BEATEN,HERE \?CCL9
	PRINTI	"The only exit is "
	EQUAL?	HERE,PYRAMID \?CCL12
	PRINTI	"south"
	JUMP	?CND10
?CCL12:	EQUAL?	HERE,PYRAMID-L \?CCL14
	PRINTI	"east"
	JUMP	?CND10
?CCL14:	PRINTI	"west"
?CND10:	PRINTC	46
	RTRUE	
?CCL9:	PRINTI	"There are no visible exits, although there's a faint outline of a doorway on the "
	EQUAL?	HERE,PYRAMID \?CCL17
	PRINTI	"south"
	JUMP	?CND15
?CCL17:	EQUAL?	HERE,PYRAMID-L \?CCL19
	PRINTI	"east"
	JUMP	?CND15
?CCL19:	PRINTI	"west"
?CND15:	PRINTI	" wall."
...
?CND1:	PRINT	PERIOD-CR
	...
	.FUNCT	PLANT-STUNNED:ANY:0:1,OBJ
	ZERO?	OBJ \?CND1
	SET	'OBJ,WINNER
?CND1:	PRINTI	"There is no response -- perhaps"
	ICALL2	TPRINT,OBJ
