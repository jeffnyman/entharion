	...
	.FUNCT	SETUP-SCREEN:ANY:0:0,?TMP1
	GETB	0,30 >MACHINE
	EQUAL?	MACHINE,IBM /?CCL2
	CALL1	APPLE?
	ZERO?	STACK /?CND1
?CCL2:	SET	'NARROW?,TRUE-VALUE
?CND1:	GETB	0,39 >FONT-X
	GETB	0,38 >FONT-Y
	MOUSE-LIMIT	-1
	GET	0,8
	BTST	STACK,32 \?CND5
...
?CND5:	GET	0,18 >?TMP1
	...
	COPYT	PICINF-TBL,SL-LOC-TBL+4,4
	ICALL2	PICINF-PLUS-ONE,COMPASS-PIC-LOC
	COPYT	PICINF-TBL,SL-LOC-TBL+8,4
	ICALL2	PICINF-PLUS-ONE,U-BOX-LOC
	COPYT	PICINF-TBL,SL-LOC-TBL+12,4
	ICALL2	PICINF-PLUS-ONE,D-BOX-LOC
	COPYT	PICINF-TBL,SL-LOC-TBL+16,4
	PICINF	ICON-OFFSET,PICINF-TBL /?BOGUS7
?BOGUS7:	COPYT	PICINF-TBL,SL-LOC-TBL+20,4
	RTRUE	
...
?CND7:	CALL1	APPLE?
	ZERO?	STACK /?CND9
	PRINTI	"Do you want to restore a saved game? (Type y or n) >"
	CALL1	Y?
	ZERO?	STACK /?CND9
	CRLF	
	RESTORE	
	...
	CRLF	
	JUMP	?FCN
?CND9:	SET	'CURRENT-SPLIT,TEXT-WINDOW-PIC-LOC
...
?PRG1:	ZERO?	NUM /TRUE
	...
	.FUNCT	SLIDE-SHOW:ANY:0:0,RM,?TMP1
	GET	0,18 >?TMP1
	GET	0,17
...
?REP3:	SET	'HERE,CROSSROADS
	...
	CLEAR	-1
	ICALL1	SETUP-CARDS
	PUTB	F-CARD-TABLE,0,7
	PUTB	F-CARD-TABLE,1,10
	PUTB	F-CARD-TABLE,2,16
	PUTB	F-CARD-TABLE,4,11
	PUTB	F-CARD-TABLE,5,15
	PUTB	F-CARD-TABLE,6,0
	PUTB	F-CARD-TABLE,8,8
	PUTB	F-CARD-TABLE,9,5
...
?CCL5:	EQUAL?	PRSA,V?PUT \FALSE
	...
	.FUNCT	BANQUET-HALL-F:ANY:0:1,RARG
...
?CCL3:	CRLF	
	...
	.FUNCT	I-FINGER-OFF-STRAW:ANY:0:0,TOLD
...
?CCL28:	CALL2	JIGS-UP,STR?257
	RSTACK	


	.FUNCT	SERVANT-ITEM-F:ANY:0:0
...
?CCL3:	EQUAL?	PRSA,V?RESEARCH \?CCL5
	CALL	PICTURED-ENTRY,DIMWIT-ILL,STR?261
	RSTACK	
...
?CCL7:	EQUAL?	PRSA,V?MUNG,V?KICK,V?KILL \FALSE
	...
	.FUNCT	G-DIMWIT-F:ANY:2:2,TBL,F,X
	GET	F,6
	EQUAL?	STACK,W?PAINTING \?CCL3
	IN?	LANDSCAPE,HERE \?CCL6
	RETURN	LANDSCAPE
?CCL6:	RETURN	PAINTINGS-1
?CCL3:	GET	F,6
	EQUAL?	STACK,W?PORTRAIT \?CCL8
	RETURN	PAINTINGS-1
?CCL8:	GET	F,6
	EQUAL?	STACK,W?FLATHEAD \?CCL10
	GET	F,5 >TBL
	ZERO?	TBL /?CCL13
	GET	TBL,4 >X
	ZERO?	X /?CCL13
	ADD	TBL,10
	INTBL?	W?DIMWIT,STACK,X \?CCL13
	RETURN	DIMWIT
?CCL13:	RETURN	PAINTINGS-1
?CCL10:	GET	F,6
	EQUAL?	STACK,W?STATUE \?CCL18
	CALL2	RUNNING?,I-PROLOGUE
	ZERO?	STACK /FALSE
...
?CCL5:	EQUAL?	PRSA,V?EXIT \FALSE
	...
	.FUNCT	CAULDRON-F:ANY:0:0,CAULDRON-SCORE
...
?CND32:	PRINTC	46
	...
	PUTP	CLOSET-REBUS-BUTTON,P?SDESC,STR?262
	FSET	BASEMENT-REBUS-BUTTON,TOUCHBIT
	PUTP	BASEMENT-REBUS-BUTTON,P?SDESC,STR?262
...
?CND36:	CRLF	
	...
	.FUNCT	PUT-ITEM-IN-CAULDRON:ANY:1:1,OBJ,X,N,CAULDRON-SCORE
	FIRST?	OBJ >X /?PRG2
?PRG2:	ZERO?	X /?REP3
	NEXT?	X >N /?BOGUS7
...
?CND10:	RETURN	CAULDRON-SCORE
	...
	.FUNCT	I-CAULDRON:ANY:0:0,X,TWO
	FIRST?	MEGABOZ \FALSE
