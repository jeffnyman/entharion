	...
	.FUNCT	VILLAGE-SEGMENT-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \FALSE
	PICINF	VILLAGE-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	


	.FUNCT	VILLAGE-F:ANY:0:0
...
?CCL7:	EQUAL?	PRSA,V?EXIT \FALSE
	...
	.FUNCT	OUTER-BAILEY-F:ANY:0:1,RARG
...
?CCL3:	EQUAL?	RARG,M-LOOK \?CCL6
	...
	FSET?	DRAWBRIDGE,OPENBIT \?CCL9
	PRINTI	"leads over the"
	JUMP	?CND7
?CCL9:	PRINTI	"is raised, leaving an impassable"
?CND7:	PRINTI	" moat to the southeast, and roads lead northeast, southwest, and northwest."
	RTRUE	
?CCL6:	EQUAL?	RARG,M-BEG \FALSE
	EQUAL?	PRSA,V?DIG \FALSE
	EQUAL?	PRSO,GROUND \FALSE
	EQUAL?	PRSI,SHOVEL \FALSE
	EQUAL?	JUMP-X,STUMP-X \FALSE
	EQUAL?	JUMP-Y,STUMP-Y \FALSE
	IN?	TREASURE-CHEST,LOCAL-GLOBALS \FALSE
	...
	.FUNCT	TREE-STUMP-F:ANY:0:1,VARG
	ZERO?	VARG \FALSE
...
?CCL18:	EQUAL?	PRSA,V?RAISE,V?TAKE,V?LOOK-UNDER \FALSE
	...
	.FUNCT	PERIMETER-WALL-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	VILLAGE-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
...
?CCL6:	EQUAL?	RARG,M-LOOK \FALSE
	...
	FSET?	OUTER-GATE,OPENBIT \?CCL16
	PRINTI	"lie wide open, revealing dense forest beyond!"
	RTRUE	
?CCL16:	PRINTI	"are closed and reinforced, forming an impassable barrier across the road from the southeast."
	RTRUE	


	.FUNCT	WEST-OF-HOUSE-ENTER-F:ANY:0:1,RARG
...
?CND12:	PRINTR	" rolls and shudders, making it difficult to stay on your feet."
	...
	.FUNCT	WEST-OF-HOUSE-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	VILLAGE-SEGMENT-PIC,PICINF-TBL /?BOGUS4
?BOGUS4:	ICALL1	RETURN-FROM-MAP
...
?CCL3:	EQUAL?	PRSA,V?ROLL \FALSE
	...
	.FUNCT	GATE-PS:ANY:0:0
	CALL2	PERFORM-PRSA,ARCH
	RSTACK	


	.FUNCT	TAX-OFFICE-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	VILLAGE-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	EQUAL?	RARG,M-END \FALSE
   ...
   """
	...
	.FUNCT	PACKAGE-F:ANY:0:0
	EQUAL?	PRSA,V?EXAMINE,V?READ \FALSE
	FONT	4
	PRINTI	"""From: Belznork Gibblewitz
...
?CCL5:	EQUAL?	PRSA,V?PUT-ON \FALSE
	...
	PRINT	STR?291
	PRINTR	"put the pigeon on the perch."


	.FUNCT	MOVE-TO-PERCH:ANY:1:1,WHAT,PERCH-LOC,L,OFFSET,RM,OBJ,X,N,TOOK-STUFF
...
?CCL125:	REMOVE	WHAT
	...
	.FUNCT	FIND-PERCH:ANY:1:1,OBJ,L,CNT
...
?REP2:	RETURN	L
	...
	.FUNCT	FR-BLDG-F:ANY:0:0
	EQUAL?	PRSA,V?RESEARCH \?CCL3
	CALL	PICTURED-ENTRY,FR-ILL,STR?554
	RSTACK	
...
?CCL10:	EQUAL?	PRSA,V?EXIT \FALSE
	...
	.FUNCT	FR-OFFICES-ENTER-F:ANY:0:1,RARG
	ZERO?	RARG /?CCL3
	RETURN	FR-OFFICES
...
?CND1:	ICALL2	OFFICE-UNSTORE,FLOOR-NUMBER
	...
	.FUNCT	OFFICES-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	VILLAGE-SEGMENT-PIC,PICINF-TBL /?BOGUS4
?BOGUS4:	SET	'BEEN-IN-FR-UPPER-FLOORS,TRUE-VALUE
	RETURN	BEEN-IN-FR-UPPER-FLOORS
?CCL3:	EQUAL?	RARG,M-LOOK \FALSE
	PRINTI	"You are on Floor "
	PRINTN	FLOOR-NUMBER
	PRINT	STR?558
	PRINTI	"s of one subsidiary or another can be entered in all four directions. Stairs lead up and down."
	RTRUE	


	.FUNCT	FR-FLOOR-F:ANY:0:1,RARG
...
?CND12:	ICALL2	OFFICE-UNSTORE,FLOOR-NUMBER
	...
	.FUNCT	OFFICE-UNSTORE:ANY:1:1,L
	...
	.FUNCT	FR-OUTER-OFFICES-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	VILLAGE-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	EQUAL?	RARG,M-LOOK \FALSE
	...
	PRINT	STR?558
	PRINTI	" has a lovely "
	EQUAL?	HERE,OFFICES-NORTH \?CCL9
	PRINTI	"north"
	JUMP	?CND7
?CCL9:	EQUAL?	HERE,OFFICES-SOUTH \?CCL11
	PRINTI	"south"
	JUMP	?CND7
?CCL11:	EQUAL?	HERE,OFFICES-EAST \?CCL13
	PRINTI	"east"
	JUMP	?CND7
?CCL13:	PRINTI	"west"
?CND7:	PRINTI	"ern exposure. The only exit is to the "
	EQUAL?	HERE,OFFICES-NORTH \?CCL16
	PRINTI	"south"
	JUMP	?CND14
?CCL16:	EQUAL?	HERE,OFFICES-SOUTH \?CCL18
	PRINTI	"north"
...
?CND14:	PRINTC	46
	...
	.FUNCT	FR-PENTHOUSE-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \FALSE
	PICINF	VILLAGE-SEGMENT-PIC,PICINF-TBL /?BOGUS4
?BOGUS4:	FSET?	FR-PENTHOUSE,TOUCHBIT /FALSE
	SET	'DO-J,TRUE-VALUE
	ICALL	QUEUE,I-JESTER,1
	RFALSE	


	.FUNCT	PHIL-ENTER-F:ANY:0:1,RARG
	ZERO?	RARG \?CND1
...
?CND1:	RETURN	PHIL-HALL
	...
	.FUNCT	FR-BASEMENT-ENTER-F:ANY:0:1,RARG
	ZERO?	RARG \?CND1
	EQUAL?	CURRENT-SPLIT,TEXT-WINDOW-PIC-LOC /?CCL2
	RETURN	FR-BASEMENT
...
?CND1:	RETURN	FR-BASEMENT
	...
	.FUNCT	RING-F:ANY:0:0,AV,HOLDING-STUFF
