...
?CCL16:	EQUAL?	PRSA,V?LOOK-INSIDE \FALSE
	...
	.FUNCT	ENC-ENTRY-F:ANY:0:0,?TMP1
...
?CND4:	GETP	PRSO,P?PICTURE >?TMP1
	...
	.FUNCT	PICTURED-ENTRY:ANY:2:3,ENC-PIC,ENC-TEXT,NO-WAIT,?TMP1
	ZERO?	ENC-TEXT \?CND1
	PRINTI	"Hmmm...the picture seems to have been torn off the page..."
	CRLF	
	CRLF	
	ICALL1	HIT-ANY-KEY
?CND1:	CLEAR	-1
	...
	GET	PICINF-TBL,1
	WINPOS	3,?TMP1,STACK
	PICINF	ENC-TXT-WINDOW-SIZE,PICINF-TBL /?BOGUS3
?BOGUS3:	GET	PICINF-TBL,0 >?TMP1
	GET	PICINF-TBL,1
	...
	CURSET	1,1
	GETB	0,30
	EQUAL?	STACK,IBM \?CCL6
	GET	0,8
	BTST	STACK,64 /?CCL6
	COLOR	C-BLACK,C-WHITE
	JUMP	?CND4
?CCL6:	COLOR	DEFAULT-FG,-1
?CND4:	ZERO?	ENC-TEXT /?CCL11
	PRINT	ENC-TEXT
	JUMP	?CND9
?CCL11:	ICALL1	J-ENTRY
?CND9:	ICALL1	2CR-TO-PRINTER
	ZERO?	NO-WAIT \TRUE
	ZERO?	DEMO-VERSION? /?CCL16
	ICALL2	INPUT-DEMO,1
	JUMP	?CND14
?CCL16:	INPUT	1
?CND14:	ICALL1	MOUSE-INPUT?
	...
	.FUNCT	OTHER-FLATHEADS-F:ANY:0:0
	EQUAL?	PRSA,V?RESEARCH \FALSE
...
?CCL10:	ICALL	PERFORM,V?RESEARCH,PAINTINGS-2
	RTRUE	


	.FUNCT	SAINTS-F:ANY:0:0
	EQUAL?	PRSA,V?RESEARCH \FALSE
...
?CND4:	PRINTR	"."""
	...
	.FUNCT	WIZARD-OF-FROBOZZ-F:ANY:0:0
	EQUAL?	PRSA,V?RESEARCH \FALSE
