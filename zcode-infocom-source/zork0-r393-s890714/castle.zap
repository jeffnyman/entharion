	...
	.FUNCT	CASTLE-SEGMENT-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \FALSE
	PICINF	CASTLE-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	


	.FUNCT	LOWER-HALL-ENTER-F:ANY:0:1,RARG
...
?CCL3:	RETURN	LOWER-HALL
	...
	.FUNCT	PROCLAMATION-F:ANY:0:0
	EQUAL?	PRSA,V?READ,V?EXAMINE \?CCL3
	FONT	4
	PRINTI	"""The one who can stop the Curse of Megaboz, and save the land from destruction, shall be rewarded with half the wealth of the Empire.
...
?CCL3:	EQUAL?	PRSA,V?TAKE \FALSE
	...
	.FUNCT	ENTRANCE-HALL-F:ANY:0:1,RARG
...
?CCL3:	EQUAL?	RARG,M-LOOK \?CCL6
	...
	FSET?	PORTCULLIS,OPENBIT /?CND7
	PRINTI	"The doorway is currently blocked by a sturdy portcullis. "
?CND7:	PRINTI	"Oddly, there is a doorbell on the inside of the doorway. Other doorways lead east, west, and south."
	RTRUE	
?CCL6:	IN?	JESTER,HERE \FALSE
	FSET?	PORTCULLIS,OPENBIT /FALSE
	EQUAL?	RARG,M-END \?CCL15
	CALL2	SETUP-ORPHAN,STR?38
	RSTACK	
?CCL15:	EQUAL?	RARG,M-BEG \FALSE
	EQUAL?	PRSA,V?TIME \FALSE
	ZERO?	PRSO \FALSE
	ICALL2	V-SAY,W?TIME
	RTRUE	


	.FUNCT	DOORBELL-F:ANY:0:0
...
?CCL5:	EQUAL?	PRSA,V?CLOSE \FALSE
	...
	.FUNCT	INNER-BAILEY-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	VILLAGE-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
...
?CCL11:	PRINTI	"Miraculously,"
	...
	.FUNCT	MURDER-HOLE-F:ANY:0:0,TAKER
...
?CCL20:	MOVE	PRSO,BARBICAN
	...
	.FUNCT	DRAWBRIDGE-F:ANY:0:1,RARG
...
?CCL11:	PRINT	STR?291
	...
	.FUNCT	PARLOR-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \FALSE
	PICINF	CASTLE-SEGMENT-PIC,PICINF-TBL /?BOGUS4
?BOGUS4:	MOVE	SPENSEWEED,FISH-TANK
	FCLEAR	SPENSEWEED,NDESCBIT
	RTRUE	


	.FUNCT	FISH-TANK-F:ANY:0:0
...
?CCL3:	EQUAL?	PRSO,FLAMINGO,ROOSTER,FOX \FALSE
	...
	.FUNCT	SPENSEWEED-F:ANY:0:0
	IN?	PROTAGONIST,DB \?CCL3
	CALL2	TOUCHING?,SPENSEWEED
	ZERO?	STACK /?CCL3
	CALL2	CANT-REACH,SPENSEWEED
	RSTACK	
?CCL3:	EQUAL?	PRSA,V?DIG,V?TAKE \?CCL7
	EQUAL?	PRSO,SPENSEWEED \?CCL7
	PRINT	DEEPLY-ROOTED
	RTRUE	
...
?CCL5:	CALL2	VISIBLE?,STARFISH
	...
	.FUNCT	BICKERING-TORCH-F:ANY:0:0
	EQUAL?	PRSA,V?TAKE \?CCL3
...
?CCL3:	EQUAL?	PRSA,V?BURN,V?ON,V?EXAMINE \FALSE
	...
	.FUNCT	BURNED-OUT:ANY:1:1,OBJ
	PRINTI	"The "
	ICALL2	DPRINT,OBJ
	PRINTR	" has burned out and cannot be rekindled."


	.FUNCT	I-BICKERING-TORCH:ANY:0:0
	ZERO?	TIME-STOPPED \FALSE
...
?CCL5:	CALL2	PROB,30
	...
	.FUNCT	FLICKERING-TORCH-F:ANY:0:0
	EQUAL?	PRSA,V?TAKE \?CCL3
...
?PRD14:	FSET?	FLICKERING-TORCH,ONBIT /FALSE
	...
	.FUNCT	I-FLICKERING-TORCH:ANY:0:0
	DEC	'FLICKERING-TORCH-COUNT
	FSET?	FLICKERING-TORCH,ONBIT /?CCL3
	PUTP	FLICKERING-TORCH,P?SDESC,STR?309
	ICALL2	DEQUEUE,I-FLICKERING-TORCH
	RFALSE	
...
?CCL9:	CALL2	PROB,40
	...
	.FUNCT	IN-THE-SKY:ANY:1:1,STRING
	PRINTI	"   The "
	PRINT	STRING
	...
	.FUNCT	MUTTERING-TORCH-F:ANY:0:0
	EQUAL?	PRSA,V?TAKE \?CCL3
...
?CCL3:	EQUAL?	PRSA,V?BURN,V?ON,V?EXAMINE \FALSE
	...
	.FUNCT	I-MUTTERING-TORCH:ANY:0:0
	ZERO?	TIME-STOPPED \FALSE
...
?CCL5:	CALL2	PROB,30
	...
	.FUNCT	GUTTERING-TORCH-F:ANY:0:0
	EQUAL?	PRSA,V?TAKE \?CCL3
...
?PRD14:	FSET?	GUTTERING-TORCH,ONBIT /FALSE
	...
	.FUNCT	I-GUTTERING-TORCH:ANY:0:0
	DEC	'GUTTERING-TORCH-COUNT
	FSET?	GUTTERING-TORCH,ONBIT /?CCL3
	PUTP	GUTTERING-TORCH,P?SDESC,STR?317
	ICALL2	DEQUEUE,I-GUTTERING-TORCH
	RFALSE	
...
?CCL9:	CALL2	PROB,40
	...
	.FUNCT	GARDEN-FLOWER-PS:ANY:0:0
...
?CCL26:	LOC	FLAMINGO
	...
	.FUNCT	COURTYARD-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	CASTLE-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	EQUAL?	RARG,M-LOOK \FALSE
	...
	JUMP	?CND7
?CCL9:	PRINTI	"Dimwit would occasionally order carnivals to be set up in this court, on totally cloudless days"
?CND7:	PRINTI	". At the distant edges of the courtyard, you can see exits to the north, west, and southeast."
	RTRUE	


	.FUNCT	BANNER-F:ANY:0:0
...
?CCL3:	EQUAL?	PRSA,V?CLIMB-DOWN \FALSE
	...
	.FUNCT	REBUS-F:ANY:0:1,OARG,CNT
...
?CCL3:	EQUAL?	PRSA,V?MOVE,V?TAKE \?CCL5
	PRINTI	"The portraits are all securely fastened to the wall."
	CRLF	
	RETURN	2
?CCL5:	EQUAL?	PRSA,V?COUNT \?CCL9
	PRINTR	"12."
?CCL9:	EQUAL?	PRSA,V?RESEARCH \FALSE
...
?CCL6:	CALL2	JIGS-UP,STR?333
	...
	.FUNCT	THRONE-ROOM-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	CASTLE-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	EQUAL?	RARG,M-LOOK \FALSE
	...
	ZERO?	SECRET-PASSAGE-OPEN /?CND7
	PRINTI	", and a secret passage is open to the south"
?CND7:	PRINTC	46
	RTRUE	


	.FUNCT	THRONE-F:ANY:0:1,VARG
...
?CCL19:	PRINTR	" is nothing but a blank wall."
	...
	.FUNCT	SECRET-SEGMENT-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \FALSE
	PICINF	SECRET-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	


	.FUNCT	SECRET-PASSAGE-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	SECRET-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	ZERO?	DEMO-VERSION? /FALSE
...
?CCL3:	EQUAL?	PRSA,V?ON \FALSE
	...
	CALL	FIND-IN,HERE,FLAMEBIT,STR?208 >FLAME
	ZERO?	FLAME /?CCL13
...
?CCL13:	PRINTR	"You have no flame to light the candle."
	...
	.FUNCT	SOLAR-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	SECRET-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	IN?	EAST-KEY,JESTER \FALSE
	IN?	JESTER,HERE \FALSE
	EQUAL?	RARG,M-END \?CCL11
	CALL2	SETUP-ORPHAN,STR?38
	RSTACK	
?CCL11:	EQUAL?	RARG,M-BEG \FALSE
	EQUAL?	PRSA,V?YES \FALSE
	ZERO?	PRSO \FALSE
	ICALL2	V-SAY,W?Y
	RTRUE	
...
?CCL11:	EQUAL?	PRSA,V?REACH-IN \FALSE
	...
	.FUNCT	CRYPT-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	SECRET-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	ZERO?	DEMO-VERSION? /?CCL6
	EQUAL?	RARG,M-END \?CCL6
	CALL1	END-DEMO
	RSTACK	
...
?CND11:	PRINTC	46
	...
	.FUNCT	ORACLE-ENTER-F:ANY:0:1,RARG
	FSET?	OUTER-GATE,OPENBIT /?CTR2
	ZERO?	TIME-STOPPED /?CCL3
?CTR2:	ZERO?	RARG \FALSE
	ICALL1	RETURN-FROM-MAP
	...
	CRLF	
	RFALSE	
?CCL3:	ZERO?	SEEN-HOLEY-SLAB /?CCL9
	RETURN	ORACLE
?CCL9:	ZERO?	RARG \FALSE
	...
	.FUNCT	SLAB-F:ANY:0:0
	CALL	ADJ-USED?,PSEUDO-OBJECT,FALSE-VALUE
	ZERO?	STACK /?CCL3
	CALL1	WHICH-PRINT
	RSTACK	
?CCL3:	EQUAL?	PRSA,V?LOOK-UNDER \FALSE
	CALL	ADJ-USED?,PSEUDO-OBJECT,HOLEY-SLAB
	ZERO?	STACK /FALSE
	FSET?	OUTER-GATE,OPENBIT /?CTR9
	ZERO?	TIME-STOPPED /?CCL10
?CTR9:	CALL2	DO-WALK,P?DOWN
	RSTACK	
?CCL10:	SET	'SEEN-HOLEY-SLAB,TRUE-VALUE
...
?CCL19:	EQUAL?	PRSA,V?ENTER \FALSE
	...
	.FUNCT	OUBLIETTE-F:ANY:0:1,RARG
	EQUAL?	RARG,M-LOOK \?CCL3
...
?CCL3:	EQUAL?	RARG,M-ENTER \?CCL8
	PICINF	SECRET-SEGMENT-PIC,PICINF-TBL /?BOGUS9
?BOGUS9:	ZERO?	TIME-STOPPED \FALSE
	SET	'DO-J,TRUE-VALUE
...
?CCL8:	EQUAL?	RARG,M-END \FALSE
	...
	.FUNCT	G-HAT-F:ANY:2:2,TBL,LEN,?TMP1
	ADD	TBL,8 >?TMP1
	GET	TBL,1
...
?CCL3:	EQUAL?	RARG,M-LOOK \?CCL6
	...
	IN?	COBWEBS,HERE \?CND7
	PRINTC	32
	PRINT	CELL-WALL-DESC
?CND7:	PRINTI	" The only exit is northwest."
	RTRUE	
?CCL6:	EQUAL?	RARG,M-BEG \FALSE
	EQUAL?	WALL,PRSO,PRSI \FALSE
...
?CND15:	CALL2	JIGS-UP,STR?361
	RSTACK	


	.FUNCT	LIQUID-F:ANY:0:0
	...
	.FUNCT	TORTURE-CHAMBER-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	SECRET-SEGMENT-PIC,PICINF-TBL /?BOGUS4
?BOGUS4:	ZERO?	METRONOME-LOC \?CND5
	CALL2	PROB,33
	ZERO?	STACK /?CCL9
...
?CCL9:	CALL2	PROB,50
	...
	JUMP	?CND5
?CCL11:	SET	'METRONOME-LOC,WATER-CHAMBER
?CND5:	SET	'METRONOME-COUNTER,0
...
?CCL3:	EQUAL?	RARG,M-END \FALSE
	...
	.FUNCT	METRONOME-TORTURE:ANY:0:1,INDENT
...
?CCL16:	PRINTR	"It is!"
	...
	.FUNCT	I-METRONOME:ANY:0:1,CALLED-BY-LISTEN,CNT
	LOC	METRONOME
...
?PRG10:	PRINTI	", tick"
	...
	.FUNCT	TORTURE-DEVICE-F:ANY:0:0
	EQUAL?	PRSA,V?ENTER \?CCL3
...
?CND4:	PRINTI	"You climb into the "
	...
	CALL2	JIGS-UP,STR?363
	RSTACK	
?CCL10:	EQUAL?	PRSO,IRON-MAIDEN \?CCL12
	CALL2	JIGS-UP,STR?364
	RSTACK	
?CCL12:	EQUAL?	PRSO,WATER-CHAMBER \?CCL14
	CALL2	JIGS-UP,STR?365
	RSTACK	
?CCL14:	CALL2	JIGS-UP,STR?366
	RSTACK	
...
?CCL37:	EQUAL?	PRSA,V?OPEN \FALSE
	...
	.FUNCT	WEST-HALL-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	WEST-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	EQUAL?	RARG,M-LOOK \FALSE
...
?CCL3:	EQUAL?	PRSA,V?LOCK \FALSE
	...
	.FUNCT	WEST-WING-F:ANY:0:1,RARG
	EQUAL?	RARG,M-LOOK \?CCL3
...
?CCL5:	EQUAL?	RARG,M-BEG \FALSE
	...
	.FUNCT	DIRIGIBLE-HANGAR-ENTER-F:ANY:0:1,RARG
	ZERO?	NUT-EATEN /?CCL3
...
?CCL7:	ICALL1	RETURN-FROM-MAP
	...
	.FUNCT	PEG-ROOM-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	WEST-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	EQUAL?	RARG,M-LOOK \FALSE
	PRINTI	"You're in a nondescript room with an exit to the south. "
	ZERO?	PEG-PASSAGE-OPENED /?CND7
	PRINTI	"A previously hidden passage leads north. "
?CND7:	PRINTI	"In the center of the room is a pegboard. Hanging on the wall are a set of instructions."
	RTRUE	


	.FUNCT	PBOZ-OBJECT-F:ANY:0:0
...
?CCL3:	EQUAL?	PRSA,V?TAKE \FALSE
	...
	.FUNCT	PEGBOARD-PEGS-F:ANY:0:0
	EQUAL?	PRSA,V?TAKE,V?MOVE \FALSE
	PRINTR	"It would behoove you to read the instructions that are posted on the wall here."


	.FUNCT	PEG-GAME:ANY:0:0,FIRST-MOVE,PEG-SELECTED,CHAR,JUMPED-PEG,DONT-CLEAR,WON,SHHH,CNT,?TMP2,?TMP1
...
?CND8:	ZERO?	SHHH \?CND11
	PRINTI	"You are moving the peg at letter "
	HLIGHT	H-BOLD
...
?CND11:	ICALL1	2CR-TO-PRINTER
	JUMP	?CND3
?CCL7:	ZERO?	FIRST-MOVE \?CND13
	ZERO?	DONT-CLEAR \?CND13
	CLEAR	S-TEXT
?CND13:	ZERO?	DONT-CLEAR \?CND3
	CALL1	PEG-COUNT
	EQUAL?	STACK,1 \?CCL21
	...
	ZERO?	STACK \?CCL25
	GETB	0,30
	EQUAL?	STACK,IBM \?CND24
?CCL25:	PRINTI	"/joystick"
?CND24:	PRINTC	41
?CND22:	PRINTC	46
	JUMP	?CND19
?CCL21:	PRINTI	"Type the letter corresponding to the peg you'd like to move"
	ZERO?	ACTIVE-MOUSE /?CND28
	PRINTI	", or use your mouse"
	CALL1	APPLE?
	ZERO?	STACK \?CCL31
	GETB	0,30
	EQUAL?	STACK,IBM \?CND30
?CCL31:	PRINTI	"/joystick"
?CND30:	PRINTI	" to click on it"
?CND28:	PRINTC	46
	ZERO?	FIRST-MOVE /?CND19
	SET	'FIRST-MOVE,FALSE-VALUE
	PRINTI	" Type X to exit Peggleboz, Y to display your moves so far, Z to reset the board"
	ZERO?	ACTIVE-MOUSE /?CND36
	PRINTI	" (or you can use your mouse"
	CALL1	APPLE?
	ZERO?	STACK \?CCL39
	GETB	0,30
	EQUAL?	STACK,IBM \?CND38
?CCL39:	PRINTI	"/joystick"
?CND38:	PRINTI	" to click on the appropriate spot)"
?CND36:	PRINTC	46
?CND19:	ICALL1	2CR-TO-PRINTER
?CND3:	SET	'DONT-CLEAR,FALSE-VALUE
	SET	'SHHH,FALSE-VALUE
	ZERO?	PEG-SELECTED /?CCL44
	MUL	PEG-SELECTED,2
	...
	JUMP	?CND42
?CCL44:	ZERO?	DEMO-VERSION? /?CCL47
	CALL2	INPUT-DEMO,1 >CHAR
	JUMP	?CND42
?CCL47:	INPUT	1 >CHAR
?CND42:	ICALL1	MOUSE-INPUT?
	EQUAL?	CHAR,CLICK1,CLICK2 \?CND48
	CALL1	PBOZ-CLICK >CHAR
?CND48:	GRTR?	CHAR,96 \?CND50
	LESS?	CHAR,123 \?CND50
	SUB	CHAR,32 >CHAR
?CND50:	EQUAL?	CHAR,88 \?CCL56
	ICALL1	RESET-PEGBOARD
	CURSET	-2
	ICALL2	INIT-SL-WITH-SPLIT,TEXT-WINDOW-PIC-LOC
	CLEAR	S-TEXT
	RTRUE	
?CCL56:	EQUAL?	CHAR,89 \?CCL58
	SET	'DONT-CLEAR,TRUE-VALUE
	ICALL1	DISPLAY-MOVES
	SET	'SHHH,TRUE-VALUE
	JUMP	?PRG1
?CCL58:	EQUAL?	CHAR,90 \?CCL60
	ICALL1	RESET-PEGBOARD
	SET	'WON,FALSE-VALUE
	SET	'CNT,4
	SCREEN	S-WINDOW
	...
	JUMP	?PRG1
?CCL60:	ZERO?	PEG-SELECTED \?CCL62
	SUB	CHAR,64 >PEG-SELECTED
	GRTR?	PEG-SELECTED,21 /?CTR64
	LESS?	PEG-SELECTED,1 \?CCL65
?CTR64:	CLEAR	S-TEXT
	SOUND	1
	SET	'PEG-SELECTED,FALSE-VALUE
	SET	'DONT-CLEAR,TRUE-VALUE
	...
	JUMP	?PRG1
?CCL65:	FSET?	NOT-HERE-OBJECT,PEG-SELECTED \?PRG1
	CLEAR	S-TEXT
	SOUND	1
	SET	'DONT-CLEAR,TRUE-VALUE
	...
	JUMP	?PRG1
?CCL62:	SUB	CHAR,64
	EQUAL?	PEG-SELECTED,STACK \?CCL70
	SET	'DONT-CLEAR,TRUE-VALUE
	SET	'PEG-SELECTED,FALSE-VALUE
	CLEAR	S-TEXT
	PRINTI	"Unselected."
	ICALL1	2CR-TO-PRINTER
	JUMP	?PRG1
?CCL70:	CALL	LEGAL-MOVE,PEG-SELECTED,CHAR >JUMPED-PEG
	ZERO?	JUMPED-PEG /?CCL72
	PUTB	PEG-MOVE-TABLE,PEG-MOVE-NUMBER,PEG-SELECTED
	ADD	PEG-MOVE-NUMBER,1 >?TMP1
	SUB	CHAR,64
	PUTB	PEG-MOVE-TABLE,?TMP1,STACK
...
?CND73:	SET	'PEG-SELECTED,FALSE-VALUE
	SCREEN	S-TEXT
	CLEAR	S-TEXT
	...
	ICALL2	INC-SCORE,16
	JUMP	?PRG1
?CCL72:	SET	'DONT-CLEAR,TRUE-VALUE
	JUMP	?PRG1


	.FUNCT	PBOZ-CLICK:ANY:0:0,TL-X,TL-Y,BR-X,BR-Y,CNT,PEG-WIDTH,PEG-HEIGHT,EXPAND-X,EXPAND-Y
	SET	'CNT,2
	ICALL2	PICINF-PLUS-ONE,PBOZ-RESTART-BOX-LOC
...
?CCL20:	DIV	CNT,2
	...
	.FUNCT	SETUP-PBOZ:ANY:0:0,I,TT,?TMP1
	SET	'I,2
...
?CND5:	SCREEN	S-TEXT
	...
	.FUNCT	DRAW-PEGS:ANY:0:0,NUM,?TMP2,?TMP1
	SET	'NUM,1
?PRG1:	FSET?	NOT-HERE-OBJECT,NUM /?CCL5
	MUL	NUM,2
	GET	BOARD-TABLE,STACK >?TMP1
	MUL	NUM,2
	ADD	STACK,1
...
?CND3:	IGRTR?	'NUM,21 \?PRG1
	...
	.FUNCT	RESET-PEGBOARD:ANY:0:0,CNT,?TMP1
	SET	'CNT,21
...
?PRG3:	FCLEAR	NOT-HERE-OBJECT,CNT
	DLESS?	'CNT,1 \?PRG3
	FSET	NOT-HERE-OBJECT,7
	COPYT	PEG-MOVE-TABLE,0,40
	RTRUE	


	.FUNCT	LEGAL-MOVE:ANY:2:2,SELECTED-PEG,CHAR,TBL,TBL-SPOT,JUMPED-PEG
	SUB	CHAR,64 >CHAR
...
?CND1:	ADD	TBL-SPOT,1
	...
	FSET?	NOT-HERE-OBJECT,CHAR /?CCL12
	CLEAR	S-TEXT
	SOUND	1
...
?CCL9:	CLEAR	S-TEXT
	...
	RFALSE	
?CCL12:	FSET?	NOT-HERE-OBJECT,JUMPED-PEG /?CCL13
	RETURN	JUMPED-PEG
?CCL13:	CLEAR	S-TEXT
	SOUND	1
	...
	.FUNCT	PBOZ-WIN-CHECK:ANY:0:0,CNT,PEG-NUM
	SET	'CNT,1
	ZERO?	PEG-PASSAGE-OPENED \FALSE
?PRG3:	EQUAL?	CNT,22 /?REP4
	FSET?	NOT-HERE-OBJECT,CNT /?CND7
	INC	'PEG-NUM
?CND7:	INC	'CNT
	JUMP	?PRG3
?REP4:	EQUAL?	PEG-NUM,1 \FALSE
	FSET?	NOT-HERE-OBJECT,7 /FALSE
	RTRUE	


	.FUNCT	PEG-COUNT:ANY:0:0,CNT,PEG-NUM
	SET	'CNT,1
?PRG1:	EQUAL?	CNT,22 /?REP2
	FSET?	NOT-HERE-OBJECT,CNT /?CND5
	INC	'PEG-NUM
?CND5:	INC	'CNT
	JUMP	?PRG1
?REP2:	RETURN	PEG-NUM
	...
	.FUNCT	DISPLAY-MOVES:ANY:0:0,X,Y,CNT
	CLEAR	S-TEXT
...
?PRG3:	MOD	CNT,10
	...
	PRINTN	STACK
	PRINTI	") "
	GETB	PEG-MOVE-TABLE,CNT
	ADD	LETTER-OFFSET,STACK
	PRINTC	STACK
	PRINTI	" -> "
	ADD	CNT,1
	GETB	PEG-MOVE-TABLE,STACK
	ADD	LETTER-OFFSET,STACK
	PRINTC	STACK
	DIROUT	D-SCREEN-OFF
	CRLF	
	...
	ADD	CNT,2 >CNT
	JUMP	?PRG3
?REP4:	ICALL1	2CR-TO-PRINTER
	FONT	1
	RSTACK	


	.FUNCT	GAMING-ROOM-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \FALSE
	PICINF	WEST-SEGMENT-PIC,PICINF-TBL /?BOGUS4
?BOGUS4:	FSET?	ZORKMID-BILL,TOUCHBIT /FALSE
	SET	'DO-J,TRUE-VALUE
...
?CCL5:	EQUAL?	PRSA,V?EXAMINE \FALSE
	PRINTR	"It's a set of 100-ugh weights, small enough to hold in one hand (but unless you're a pretty awesome athlete, not nearly light enough to hold in one hand)."
	...
	.FUNCT	EAST-SEGMENT-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \FALSE
	PICINF	EAST-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	


	.FUNCT	EAST-HALL-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	EAST-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	EQUAL?	RARG,M-LOOK \FALSE
...
?CCL56:	PRINTI	"You feel a crackle of magical energy, but there doesn't seem to be any effect on"
	...
	.FUNCT	LOWER-SEGMENT-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \FALSE
	PICINF	LOWER-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	


	.FUNCT	TESTING-ROOM-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	LOWER-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	EQUAL?	RARG,M-BEG \FALSE
	EQUAL?	LEFT-RIGHT,PRSO,PRSI \FALSE
	CALL	NOUN-USED?,LEFT-RIGHT,W?RIGHT
	ZERO?	STACK /?CCL11
	PUSH	RIGHT-BOOTH
	JUMP	?CND9
?CCL11:	PUSH	LEFT-BOOTH
?CND9:	CALL	PERFORM,V?ENTER,STACK
	RSTACK	


	.FUNCT	G-BOOTH-F:ANY:2:2,TBL,LEN
...
?CCL7:	EQUAL?	PRSA,V?EXAMINE \FALSE
	...
	.FUNCT	G-BUTTON-F:ANY:2:2,TBL,LEN
...
?CCL5:	RETURN	NOT-HERE-OBJECT
	...
	.FUNCT	BOOTH-BUTTON-F:ANY:0:0,OTHER-BOOTH,THE-FLY
	EQUAL?	PRSA,V?PUSH \FALSE
	ZERO?	ALLIGATOR /?CND4
...
?CND10:	MOVE	LEFT-BOOTH-BUTTON,LEFT-BOOTH
	...
	.FUNCT	TO-SPEAK-OF:ANY:1:1,STRING
	PRINTI	"Ummm..."
...
?CND13:	PRINTI	"As you sit on the toboggan, it begins to slide down the mountain, gathering speed as it goes. The passing landscape begins to blur, and then even the blur is gone as the icy wind forces your eyes shut. Suddenly, with a jolt like a mighty hand grabbing you, you are still! You open your eyes"
	...
	.FUNCT	CAGE-F:ANY:0:0
	EQUAL?	PRSA,V?OPEN \?CCL3
	IN?	SNAKE,CAGE \?CCL6
	FSET?	SNAKE,ANIMATEDBIT \?CCL6
	CALL2	JIGS-UP,STR?394
	RSTACK	
...
?CCL7:	EQUAL?	PRSA,V?TIE \?CCL14
	...
	FSET?	PRSI,PLANTBIT \?CCL19
	CALL1	WASTES
	RSTACK	
?CCL19:	PRINT	YOU-CANT
	PRINTI	"tie the rope to"
	CALL2	TRPRINT,PRSI
	RSTACK	
?CCL14:	EQUAL?	PRSA,V?UNTIE \?CCL21
	ZERO?	ROPE-PLACED /?CCL21
	SET	'ROPE-PLACED,FALSE-VALUE
	PRINTR	"You untie the rope from the spire."
?CCL21:	EQUAL?	PRSA,V?CLIMB-DOWN \?CCL25
	ZERO?	ROPE-PLACED /?CCL25
	CALL2	DO-WALK,P?DOWN
	RSTACK	
?CCL25:	EQUAL?	PRSA,V?MEASURE,V?EXAMINE \FALSE
	PRINTR	"The rope is about twenty feet long."


	.FUNCT	I-W-SNAKE:ANY:0:0,TOLD
...
?CCL3:	EQUAL?	PRSA,V?LOCK \?CCL7
	...
	CALL	DO-FIRST,STR?400,VAULT-DOOR
	RSTACK	
...
?CCL26:	SET	'DIAL-NUMBER,P-NUMBER
	...
	.FUNCT	VAULT-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CCL3
	PICINF	LOWER-SEGMENT-PIC,PICINF-TBL /FALSE
	RFALSE	
?CCL3:	ZERO?	RARG \FALSE
	EQUAL?	PRSA,V?LOCK,V?CLOSE,V?OPEN /?PRD10
	EQUAL?	PRSA,V?UNLOCK \FALSE
?PRD10:	EQUAL?	PRSO,GLOBAL-HERE,VAULT \FALSE
	...
	.FUNCT	NW-SE-PASSAGE-F:ANY:1:1,OARG
	EQUAL?	OARG,M-OBJDESC? /TRUE
	PRINTI	"   "
	...
	.FUNCT	N-S-PASSAGE-F:ANY:1:1,OARG
	EQUAL?	OARG,M-OBJDESC? /TRUE
	PRINTI	"   "
...
?CCL17:	CALL2	DO-WALK,NW-SE-PASSAGE-DIR
	...
	.FUNCT	D-PASSAGE:ANY:1:1,PASSAGE,?TMP1
...
?CND4:	PRINTI	" The open pit seems to have handholds leading downward"
	...
	.FUNCT	PIT-ENTER-F:ANY:0:1,RARG
	FSET?	LANTERN,TRYTAKEBIT \?CCL3
	ZERO?	RARG \FALSE
	ICALL1	RETURN-FROM-MAP
...
?CCL24:	EQUAL?	PRSA,V?ENTER \FALSE
	...
	.FUNCT	LANTERN-F:ANY:0:0
	EQUAL?	PRSA,V?EXAMINE \?CCL3
	FSET?	LANTERN,TRYTAKEBIT \?CCL6
	PRINT	STR?132
	PRINTR	" from this distance."
...
?CCL20:	PRINTI	"The lantern flickers and dies."
	...
	.FUNCT	LEDGE-IN-PIT-PS:ANY:0:0
	EQUAL?	PRSA,V?EXIT \FALSE
	CALL1	V-WALK-AROUND
	RSTACK	


	.FUNCT	UNDER-THE-WORLD-F:ANY:0:1,RARG
	EQUAL?	RARG,M-ENTER \?CND1
	PICINF	LOWER-SEGMENT-PIC,PICINF-TBL /?CND1
?CND1:	EQUAL?	HERE,UNDER-THE-WORLD \?CCL6
	EQUAL?	RARG,M-ENTER \?CCL6
	ZERO?	ALLIGATOR /?CCL11
	ICALL1	RETURN-FROM-MAP
	CALL2	JIGS-UP,STR?418
	RSTACK	
?CCL11:	FSET?	UNDER-THE-WORLD,TOUCHBIT /FALSE
	ICALL1	RETURN-FROM-MAP
...
?CCL6:	EQUAL?	RARG,M-BEG \FALSE
	...
	EQUAL?	PRSO,ROOMS,FALSE-VALUE \FALSE
	ZERO?	TURNED-INTO /?CCL15
	FSET?	TURNED-INTO,ANIMATEDBIT /?CCL15
	EQUAL?	TURNED-INTO,LITTLE-FUNGUS \FALSE
?CCL15:	CALL2	JIGS-UP,STR?419
	RSTACK	


	.FUNCT	ROOTS-F:ANY:0:0
...
?CCL3:	EQUAL?	RARG,M-LOOK \FALSE
	...
	ZERO?	EAR-PASSAGE-OPEN /?CND7
	PRINTI	", except for a small tunnel through the fungus which leads farther in"
?CND7:	PRINTI	". The only exit is down."
	RTRUE	


	.FUNCT	EAR-FUNGUS-F:ANY:0:1,ARG
	EQUAL?	ARG,M-WINNER \?CCL3
	CALL1	PLANT-STUNNED
	RSTACK	
...
?CND14:	PRINT	PERIOD-CR
	...
	.FUNCT	G-FUNGUS-F:ANY:2:2,STR,LEN
	EQUAL?	PRSA,V?RESEARCH \FALSE
	RETURN	EAR-FUNGUS


	.FUNCT	BROGMOID-F:ANY:0:0
...
?CCL14:	EQUAL?	PRSA,V?CLEAN \?CCL19
	...
	RTRUE	
?CCL19:	EQUAL?	PRSA,V?RESEARCH \?CCL23
...
?CCL23:	EQUAL?	PRSA,V?TELL,V?ASK-FOR \FALSE
	EQUAL?	PRSO,BROGMOID \FALSE
