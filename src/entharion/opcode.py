...
opcodes = [
    ...
    Opcode(name="catch", versions=[5, 6, 7, 8], opcode_bytes=(185, 9), store=True),
    ...
    Opcode(name="get_sibling", versions="all", opcode_bytes=(129, 1), store=True),
    Opcode(name="get_sibling", versions="all", opcode_bytes=(145, 1), store=True),
    Opcode(name="get_sibling", versions="all", opcode_bytes=(161, 1), store=True),
    Opcode(name="get_child", versions="all", opcode_bytes=(130, 2), store=True),
    Opcode(name="get_child", versions="all", opcode_bytes=(146, 2), store=True),
    Opcode(name="get_child", versions="all", opcode_bytes=(162, 2), store=True),
    Opcode(name="get_parent", versions="all", opcode_bytes=(131, 3), store=True),
    Opcode(name="get_parent", versions="all", opcode_bytes=(147, 3), store=True),
    Opcode(name="get_parent", versions="all", opcode_bytes=(163, 3), store=True),
    Opcode(name="get_prop_len", versions="all", opcode_bytes=(132, 4), store=True),
    Opcode(name="get_prop_len", versions="all", opcode_bytes=(148, 4), store=True),
    Opcode(name="get_prop_len", versions="all", opcode_bytes=(164, 4), store=True),
    ...
    Opcode(name="call_1s", versions=[4, 5, 6, 7, 8], opcode_bytes=(136, 8), store=True),
    Opcode(name="call_1s", versions="all", opcode_bytes=(152, 8), store=True),
    Opcode(name="call_1s", versions="all", opcode_bytes=(168, 8), store=True),
    ...
    Opcode(name="load", versions="all", opcode_bytes=(142, 14), store=True),
    Opcode(name="load", versions="all", opcode_bytes=(158, 14), store=True),
    Opcode(name="load", versions="all", opcode_bytes=(174, 14), store=True),
    Opcode(name="not", versions=[1, 2, 3, 4], opcode_bytes=(143, 15), store=True),
    ...
    Opcode(name="or", versions="all", opcode_bytes=(8, 8), store=True),
    Opcode(name="or", versions="all", opcode_bytes=(40, 8), store=True),
    Opcode(name="or", versions="all", opcode_bytes=(72, 8), store=True),
    Opcode(name="or", versions="all", opcode_bytes=(104, 8), store=True),
    Opcode(name="or", versions="all", opcode_bytes=(200, 8), store=True),
    Opcode(name="and", versions="all", opcode_bytes=(9, 9), store=True),
    Opcode(name="and", versions="all", opcode_bytes=(41, 9), store=True),
    Opcode(name="and", versions="all", opcode_bytes=(73, 9), store=True),
    Opcode(name="and", versions="all", opcode_bytes=(105, 9), store=True),
    Opcode(name="and", versions="all", opcode_bytes=(201, 9), store=True),
    ...
    Opcode(name="loadw", versions="all", opcode_bytes=(15, 15), store=True),
    Opcode(name="loadw", versions="all", opcode_bytes=(47, 15), store=True),
    Opcode(name="loadw", versions="all", opcode_bytes=(79, 15), store=True),
    Opcode(name="loadw", versions="all", opcode_bytes=(111, 15), store=True),
    Opcode(name="loadw", versions="all", opcode_bytes=(207, 15), store=True),
    Opcode(name="loadb", versions="all", opcode_bytes=(16, 16), store=True),
    Opcode(name="loadb", versions="all", opcode_bytes=(48, 16), store=True),
    Opcode(name="loadb", versions="all", opcode_bytes=(80, 16), store=True),
    Opcode(name="loadb", versions="all", opcode_bytes=(112, 16), store=True),
    Opcode(name="loadb", versions="all", opcode_bytes=(208, 16), store=True),
    Opcode(name="get_prop", versions="all", opcode_bytes=(17, 17), store=True),
    Opcode(name="get_prop", versions="all", opcode_bytes=(49, 17), store=True),
    Opcode(name="get_prop", versions="all", opcode_bytes=(81, 17), store=True),
    Opcode(name="get_prop", versions="all", opcode_bytes=(113, 17), store=True),
    Opcode(name="get_prop", versions="all", opcode_bytes=(209, 17), store=True),
    Opcode(name="get_prop_addr", versions="all", opcode_bytes=(18, 18), store=True),
    Opcode(name="get_prop_addr", versions="all", opcode_bytes=(50, 18), store=True),
    Opcode(name="get_prop_addr", versions="all", opcode_bytes=(82, 18), store=True),
    Opcode(name="get_prop_addr", versions="all", opcode_bytes=(114, 18), store=True),
    Opcode(name="get_prop_addr", versions="all", opcode_bytes=(210, 18), store=True),
    Opcode(name="get_next_prop", versions="all", opcode_bytes=(19, 19), store=True),
    Opcode(name="get_next_prop", versions="all", opcode_bytes=(51, 19), store=True),
    Opcode(name="get_next_prop", versions="all", opcode_bytes=(83, 19), store=True),
    Opcode(name="get_next_prop", versions="all", opcode_bytes=(115, 19), store=True),
    Opcode(name="get_next_prop", versions="all", opcode_bytes=(211, 19), store=True),
    Opcode(name="add", versions="all", opcode_bytes=(20, 20), store=True),
    Opcode(name="add", versions="all", opcode_bytes=(52, 20), store=True),
    Opcode(name="add", versions="all", opcode_bytes=(84, 20), store=True),
    Opcode(name="add", versions="all", opcode_bytes=(116, 20), store=True),
    Opcode(name="add", versions="all", opcode_bytes=(212, 20), store=True),
    Opcode(name="sub", versions="all", opcode_bytes=(21, 21), store=True),
    Opcode(name="sub", versions="all", opcode_bytes=(53, 21), store=True),
    Opcode(name="sub", versions="all", opcode_bytes=(85, 21), store=True),
    Opcode(name="sub", versions="all", opcode_bytes=(117, 21), store=True),
    Opcode(name="sub", versions="all", opcode_bytes=(213, 21), store=True),
    Opcode(name="mul", versions="all", opcode_bytes=(22, 22), store=True),
    Opcode(name="mul", versions="all", opcode_bytes=(54, 22), store=True),
    Opcode(name="mul", versions="all", opcode_bytes=(86, 22), store=True),
    Opcode(name="mul", versions="all", opcode_bytes=(118, 22), store=True),
    Opcode(name="mul", versions="all", opcode_bytes=(214, 22), store=True),
    Opcode(name="div", versions="all", opcode_bytes=(23, 23), store=True),
    Opcode(name="div", versions="all", opcode_bytes=(55, 23), store=True),
    Opcode(name="div", versions="all", opcode_bytes=(87, 23), store=True),
    Opcode(name="div", versions="all", opcode_bytes=(119, 23), store=True),
    Opcode(name="div", versions="all", opcode_bytes=(215, 23), store=True),
    Opcode(name="mod", versions="all", opcode_bytes=(24, 24), store=True),
    Opcode(name="mod", versions="all", opcode_bytes=(56, 24), store=True),
    Opcode(name="mod", versions="all", opcode_bytes=(88, 24), store=True),
    Opcode(name="mod", versions="all", opcode_bytes=(120, 24), store=True),
    Opcode(name="mod", versions="all", opcode_bytes=(216, 24), store=True),
    Opcode(name="call_2s", versions=[4, 5, 6, 7, 8], opcode_bytes=(25, 25)),
    Opcode(name="call_2s", versions="all", opcode_bytes=(57, 25), store=True),
    Opcode(name="call_2s", versions="all", opcode_bytes=(89, 25), store=True),
    Opcode(name="call_2s", versions="all", opcode_bytes=(121, 25), store=True),
    Opcode(name="call_2s", versions="all", opcode_bytes=(217, 25), store=True),
    ...
    Opcode(name="aread", versions=[5, 6, 7, 8], opcode_bytes=(228, 4), store=True),
    Opcode(name="print_char", versions="all", opcode_bytes=(229, 5)),
    Opcode(name="print_num", versions="all", opcode_bytes=(230, 6)),
    Opcode(name="random", versions="all", opcode_bytes=(231, 7), store=True),
    ...
    Opcode(name="pull", versions="all", opcode_bytes=(233, 9), store=True),
    ...
    Opcode(name="not", versions=[5, 6, 7, 8], opcode_bytes=(248, 24), store=True),
    ...
    # EXT
    Opcode(name="save", versions="all", opcode_bytes=(0, 0), store=True),
    Opcode(name="restore", versions=[5, 6, 7, 8], opcode_bytes=(1, 1), store=True),
    Opcode(name="log_shift", versions=[5, 6, 7, 8], opcode_bytes=(2, 2), store=True),
    Opcode(name="art_shift", versions=[5, 6, 7, 8], opcode_bytes=(3, 3), store=True),
    Opcode(name="set_font", versions=[5, 6, 7, 8], opcode_bytes=(4, 4), store=True),
    ...
    Opcode(name="save_undo", versions=[5, 6, 7, 8], opcode_bytes=(9, 9), store=True),
    Opcode(
    ...
    Opcode(name="get_wind_prop", versions=[6, 7, 8], opcode_bytes=(19, 19), store=True),
    ...
    Opcode(name="buffer_screen", versions=[6, 7, 8], opcode_bytes=(29, 29), store=True),
]
